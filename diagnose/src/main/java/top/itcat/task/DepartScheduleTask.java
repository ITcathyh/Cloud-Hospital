 ...
 * @author ITcathyh
 */
public class DepartScheduleTask implements Callable<DepartSchedualTaskResult> {
    private ScheduleRuleService scheduleRuleService;
    private TransactionalAction transactionalAction;
    private long departId;

    public DepartScheduleTask(ScheduleRuleService scheduleRuleService,
    ...
    public DepartSchedualTaskResult call() throws Exception {
        ...
        DateTime time = new DateTime().plusWeeks(1).dayOfWeek().withMinimumValue().withMillisOfDay(0);
