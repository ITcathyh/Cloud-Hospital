...
public class DepartApiTest {
    ...
    public void testGetDepart() throws Exception {
        ...
        JSONObject json = JSON.parseObject(mockMvc.perform(MockMvcRequestBuilders.post("/department/get")
    ...
    public void testUpdateDepart() throws Exception {
        ...
        entity.setId(140L);
        JSONObject entityJson = (JSONObject) JSONObject.toJSON(entity);
        req.put("department", entityJson);

        JSONObject json = JSON.parseObject(mockMvc.perform(MockMvcRequestBuilders.
                post("/department/manage/update")
                .contentType(MediaType.APPLICATION_JSON)
                .content(req.toJSONString())
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
