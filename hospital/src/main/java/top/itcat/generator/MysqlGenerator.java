...
public class MysqlGenerator {
    ...
    private static String[] tables = {"billing_category", "registration_level", "nonmedical_charge"};
    private static File file = new File("generator");
    private static String path = file.getAbsolutePath();
    private static String url = "jdbc:mysql://localhost:3306/neu_hospital?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true";
