...
public class MysqlGenerator {
    private static String[] tables = {"patient_wechat_signature"};
    private static File file = new File("generator");
    private static String path = file.getAbsolutePath();
    private static String url = "jdbc:mysql://localhost:3306/user?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true";
