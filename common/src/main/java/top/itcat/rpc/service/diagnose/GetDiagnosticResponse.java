...
public class GetDiagnosticResponse implements org.apache.thrift.TBase<GetDiagnosticResponse, GetDiagnosticResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetDiagnosticResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetDiagnosticResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetDiagnosticResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetDiagnosticResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.Diagnostic> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetDiagnosticResponse.class, metaDataMap);
  }

  public GetDiagnosticResponse() {
  }
   ...
   */
  public GetDiagnosticResponse(GetDiagnosticResponse other) {
  ...
  public GetDiagnosticResponse deepCopy() {
  ...
  public GetDiagnosticResponse setBeanList(List<top.itcat.rpc.service.model.Diagnostic> beanList) {
  ...
  public GetDiagnosticResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetDiagnosticResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetDiagnosticResponse)
      return this.equals((GetDiagnosticResponse)that);
    return false;
  }

  public boolean equals(GetDiagnosticResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetDiagnosticResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetDiagnosticResponse(");
    boolean first = true;
  ...
  private static class GetDiagnosticResponseStandardSchemeFactory implements SchemeFactory {
    public GetDiagnosticResponseStandardScheme getScheme() {
      return new GetDiagnosticResponseStandardScheme();
    }
  }

  private static class GetDiagnosticResponseStandardScheme extends StandardScheme<GetDiagnosticResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetDiagnosticResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.Diagnostic>(_list56.size);
                top.itcat.rpc.service.model.Diagnostic _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new top.itcat.rpc.service.model.Diagnostic();
                  _elem57.read(iprot);
                  struct.beanList.add(_elem57);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetDiagnosticResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Diagnostic _iter59 : struct.beanList)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetDiagnosticResponseTupleSchemeFactory implements SchemeFactory {
    public GetDiagnosticResponseTupleScheme getScheme() {
      return new GetDiagnosticResponseTupleScheme();
    }
  }

  private static class GetDiagnosticResponseTupleScheme extends TupleScheme<GetDiagnosticResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetDiagnosticResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.Diagnostic _iter60 : struct.beanList)
          {
            _iter60.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetDiagnosticResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.Diagnostic>(_list61.size);
          top.itcat.rpc.service.model.Diagnostic _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new top.itcat.rpc.service.model.Diagnostic();
            _elem62.read(iprot);
            struct.beanList.add(_elem62);
          }
        }
        struct.setBeanListIsSet(true);
      }
