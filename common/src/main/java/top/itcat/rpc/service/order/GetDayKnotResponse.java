...
public class GetDayKnotResponse implements org.apache.thrift.TBase<GetDayKnotResponse, GetDayKnotResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetDayKnotResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetDayKnotResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetDayKnotResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetDayKnotResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetDayKnotResponse.class, metaDataMap);
  }

  public GetDayKnotResponse() {
  }
   ...
   */
  public GetDayKnotResponse(GetDayKnotResponse other) {
  ...
  public GetDayKnotResponse deepCopy() {
    return new GetDayKnotResponse(this);
  }
  ...
  public GetDayKnotResponse setBeanList(List<top.itcat.rpc.service.model.DayKnot> beanList) {
  ...
  public GetDayKnotResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetDayKnotResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetDayKnotResponse)
      return this.equals((GetDayKnotResponse)that);
    return false;
  }

  public boolean equals(GetDayKnotResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetDayKnotResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetDayKnotResponse(");
    boolean first = true;
  ...
  private static class GetDayKnotResponseStandardSchemeFactory implements SchemeFactory {
    public GetDayKnotResponseStandardScheme getScheme() {
      return new GetDayKnotResponseStandardScheme();
    }
  }

  private static class GetDayKnotResponseStandardScheme extends StandardScheme<GetDayKnotResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetDayKnotResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.DayKnot>(_list48.size);
                top.itcat.rpc.service.model.DayKnot _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new top.itcat.rpc.service.model.DayKnot();
                  _elem49.read(iprot);
                  struct.beanList.add(_elem49);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetDayKnotResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.DayKnot _iter51 : struct.beanList)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetDayKnotResponseTupleSchemeFactory implements SchemeFactory {
    public GetDayKnotResponseTupleScheme getScheme() {
      return new GetDayKnotResponseTupleScheme();
    }
  }

  private static class GetDayKnotResponseTupleScheme extends TupleScheme<GetDayKnotResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetDayKnotResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.DayKnot _iter52 : struct.beanList)
          {
            _iter52.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetDayKnotResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.DayKnot>(_list53.size);
          top.itcat.rpc.service.model.DayKnot _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = new top.itcat.rpc.service.model.DayKnot();
            _elem54.read(iprot);
            struct.beanList.add(_elem54);
          }
        }
        struct.setBeanListIsSet(true);
      }
