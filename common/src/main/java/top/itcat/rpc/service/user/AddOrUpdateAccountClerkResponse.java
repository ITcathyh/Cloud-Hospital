...
public class AddOrUpdateAccountClerkResponse implements org.apache.thrift.TBase<AddOrUpdateAccountClerkResponse, AddOrUpdateAccountClerkResponse._Fields>, java.io.Serializable, Cloneable, Comparable<AddOrUpdateAccountClerkResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddOrUpdateAccountClerkResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new AddOrUpdateAccountClerkResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddOrUpdateAccountClerkResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.AccountClerk> users; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddOrUpdateAccountClerkResponse.class, metaDataMap);
  }

  public AddOrUpdateAccountClerkResponse() {
  }
   ...
   */
  public AddOrUpdateAccountClerkResponse(AddOrUpdateAccountClerkResponse other) {
    if (other.isSetUsers()) {
  ...
  public AddOrUpdateAccountClerkResponse deepCopy() {
    return new AddOrUpdateAccountClerkResponse(this);
  }
  ...
  public AddOrUpdateAccountClerkResponse setUsers(List<top.itcat.rpc.service.model.AccountClerk> users) {
    this.users = users;
    return this;
  }
  ...
  public AddOrUpdateAccountClerkResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddOrUpdateAccountClerkResponse)
      return this.equals((AddOrUpdateAccountClerkResponse)that);
    return false;
  }

  public boolean equals(AddOrUpdateAccountClerkResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddOrUpdateAccountClerkResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddOrUpdateAccountClerkResponse(");
    boolean first = true;
  ...
  private static class AddOrUpdateAccountClerkResponseStandardSchemeFactory implements SchemeFactory {
    public AddOrUpdateAccountClerkResponseStandardScheme getScheme() {
      return new AddOrUpdateAccountClerkResponseStandardScheme();
    }
  }

  private static class AddOrUpdateAccountClerkResponseStandardScheme extends StandardScheme<AddOrUpdateAccountClerkResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddOrUpdateAccountClerkResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<top.itcat.rpc.service.model.AccountClerk>(_list88.size);
                top.itcat.rpc.service.model.AccountClerk _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                {
                  _elem89 = new top.itcat.rpc.service.model.AccountClerk();
                  _elem89.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddOrUpdateAccountClerkResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.users != null) {
        if (struct.isSetUsers()) {
          oprot.writeFieldBegin(USERS_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.AccountClerk _iter91 : struct.users)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class AddOrUpdateAccountClerkResponseTupleSchemeFactory implements SchemeFactory {
    public AddOrUpdateAccountClerkResponseTupleScheme getScheme() {
      return new AddOrUpdateAccountClerkResponseTupleScheme();
    }
  }

  private static class AddOrUpdateAccountClerkResponseTupleScheme extends TupleScheme<AddOrUpdateAccountClerkResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddOrUpdateAccountClerkResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUsers()) {
        {
          ...
          for (top.itcat.rpc.service.model.AccountClerk _iter92 : struct.users)
          {
            _iter92.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddOrUpdateAccountClerkResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.users = new ArrayList<top.itcat.rpc.service.model.AccountClerk>(_list93.size);
          top.itcat.rpc.service.model.AccountClerk _elem94;
          for (int _i95 = 0; _i95 < _list93.size; ++_i95)
          {
            _elem94 = new top.itcat.rpc.service.model.AccountClerk();
            _elem94.read(iprot);
