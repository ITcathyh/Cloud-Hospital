...
public class GetDiagnosticRequest implements org.apache.thrift.TBase<GetDiagnosticRequest, GetDiagnosticRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetDiagnosticRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetDiagnosticRequest");
  ...
  private static final org.apache.thrift.protocol.TField SECOND_DIAG_DIR_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("secondDiagDirId", org.apache.thrift.protocol.TType.I64, (short)2);
  ...
  static {
    schemes.put(StandardScheme.class, new GetDiagnosticRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetDiagnosticRequestTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    IDS((short)1, "ids"),
    SECOND_DIAG_DIR_ID((short)2, "secondDiagDirId"),
  ...
  private static final int __SECONDDIAGDIRID_ISSET_ID = 0;
  private static final int __OFFSET_ISSET_ID = 1;
  private static final int __LIMIT_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.IDS,_Fields.SECOND_DIAG_DIR_ID,_Fields.OFFSET,_Fields.LIMIT,_Fields.SEARCH_KEY};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetDiagnosticRequest.class, metaDataMap);
  }
   ...
   */
  public GetDiagnosticRequest(GetDiagnosticRequest other) {
  ...
  public GetDiagnosticRequest deepCopy() {
  ...
  public GetDiagnosticRequest setIds(List<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public GetDiagnosticRequest setSecondDiagDirId(long secondDiagDirId) {
  ...
  public GetDiagnosticRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public GetDiagnosticRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public GetDiagnosticRequest setSearchKey(String searchKey) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetDiagnosticRequest)
      return this.equals((GetDiagnosticRequest)that);
    return false;
  }

  public boolean equals(GetDiagnosticRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetDiagnosticRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetDiagnosticRequest(");
    boolean first = true;
  ...
  private static class GetDiagnosticRequestStandardSchemeFactory implements SchemeFactory {
    public GetDiagnosticRequestStandardScheme getScheme() {
      return new GetDiagnosticRequestStandardScheme();
    }
  }

  private static class GetDiagnosticRequestStandardScheme extends StandardScheme<GetDiagnosticRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetDiagnosticRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetDiagnosticRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetDiagnosticRequestTupleSchemeFactory implements SchemeFactory {
    public GetDiagnosticRequestTupleScheme getScheme() {
      return new GetDiagnosticRequestTupleScheme();
    }
  }

  private static class GetDiagnosticRequestTupleScheme extends TupleScheme<GetDiagnosticRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetDiagnosticRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetDiagnosticRequest struct) throws org.apache.thrift.TException {
