...
public class GetPrescriptionHerbResponse implements org.apache.thrift.TBase<GetPrescriptionHerbResponse, GetPrescriptionHerbResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetPrescriptionHerbResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetPrescriptionHerbResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetPrescriptionHerbResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetPrescriptionHerbResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.PrescriptionHerb> beanList; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BEAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("beanList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, top.itcat.rpc.service.model.PrescriptionHerb.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetPrescriptionHerbResponse.class, metaDataMap);
  }

  public GetPrescriptionHerbResponse() {
  }
   ...
   */
  public GetPrescriptionHerbResponse(GetPrescriptionHerbResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.PrescriptionHerb> __this__beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionHerb>(other.beanList.size());
      for (top.itcat.rpc.service.model.PrescriptionHerb other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.PrescriptionHerb(other_element));
      }
  ...
  public GetPrescriptionHerbResponse deepCopy() {
    return new GetPrescriptionHerbResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.PrescriptionHerb> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.PrescriptionHerb elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionHerb>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.PrescriptionHerb> getBeanList() {
    return this.beanList;
  }

  public GetPrescriptionHerbResponse setBeanList(List<top.itcat.rpc.service.model.PrescriptionHerb> beanList) {
  ...
  public GetPrescriptionHerbResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetPrescriptionHerbResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.PrescriptionHerb>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetPrescriptionHerbResponse)
      return this.equals((GetPrescriptionHerbResponse)that);
    return false;
  }

  public boolean equals(GetPrescriptionHerbResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetPrescriptionHerbResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetPrescriptionHerbResponse(");
    boolean first = true;
  ...
  private static class GetPrescriptionHerbResponseStandardSchemeFactory implements SchemeFactory {
    public GetPrescriptionHerbResponseStandardScheme getScheme() {
      return new GetPrescriptionHerbResponseStandardScheme();
    }
  }

  private static class GetPrescriptionHerbResponseStandardScheme extends StandardScheme<GetPrescriptionHerbResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetPrescriptionHerbResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionHerb>(_list98.size);
                top.itcat.rpc.service.model.PrescriptionHerb _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = new top.itcat.rpc.service.model.PrescriptionHerb();
                  _elem99.read(iprot);
                  struct.beanList.add(_elem99);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPrescriptionHerbResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.PrescriptionHerb _iter101 : struct.beanList)
            {
  ...
  private static class GetPrescriptionHerbResponseTupleSchemeFactory implements SchemeFactory {
    public GetPrescriptionHerbResponseTupleScheme getScheme() {
      return new GetPrescriptionHerbResponseTupleScheme();
    }
  }

  private static class GetPrescriptionHerbResponseTupleScheme extends TupleScheme<GetPrescriptionHerbResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionHerbResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.PrescriptionHerb _iter102 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionHerbResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionHerb>(_list103.size);
          top.itcat.rpc.service.model.PrescriptionHerb _elem104;
          for (int _i105 = 0; _i105 < _list103.size; ++_i105)
          {
            _elem104 = new top.itcat.rpc.service.model.PrescriptionHerb();
            _elem104.read(iprot);
            struct.beanList.add(_elem104);
          }
        }
        struct.setBeanListIsSet(true);
      }
