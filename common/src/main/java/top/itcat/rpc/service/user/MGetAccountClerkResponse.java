...
public class MGetAccountClerkResponse implements org.apache.thrift.TBase<MGetAccountClerkResponse, MGetAccountClerkResponse._Fields>, java.io.Serializable, Cloneable, Comparable<MGetAccountClerkResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MGetAccountClerkResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new MGetAccountClerkResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MGetAccountClerkResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MGetAccountClerkResponse.class, metaDataMap);
  }

  public MGetAccountClerkResponse() {
  }
   ...
   */
  public MGetAccountClerkResponse(MGetAccountClerkResponse other) {
  ...
  public MGetAccountClerkResponse deepCopy() {
    return new MGetAccountClerkResponse(this);
  }
  ...
  public MGetAccountClerkResponse setUsers(List<top.itcat.rpc.service.model.AccountClerk> users) {
    this.users = users;
    return this;
  }
  ...
  public MGetAccountClerkResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public MGetAccountClerkResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MGetAccountClerkResponse)
      return this.equals((MGetAccountClerkResponse)that);
    return false;
  }

  public boolean equals(MGetAccountClerkResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MGetAccountClerkResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MGetAccountClerkResponse(");
    boolean first = true;
  ...
  private static class MGetAccountClerkResponseStandardSchemeFactory implements SchemeFactory {
    public MGetAccountClerkResponseStandardScheme getScheme() {
      return new MGetAccountClerkResponseStandardScheme();
    }
  }

  private static class MGetAccountClerkResponseStandardScheme extends StandardScheme<MGetAccountClerkResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MGetAccountClerkResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<top.itcat.rpc.service.model.AccountClerk>(_list72.size);
                top.itcat.rpc.service.model.AccountClerk _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new top.itcat.rpc.service.model.AccountClerk();
                  _elem73.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MGetAccountClerkResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.users != null) {
        if (struct.isSetUsers()) {
          oprot.writeFieldBegin(USERS_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.AccountClerk _iter75 : struct.users)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class MGetAccountClerkResponseTupleSchemeFactory implements SchemeFactory {
    public MGetAccountClerkResponseTupleScheme getScheme() {
      return new MGetAccountClerkResponseTupleScheme();
    }
  }

  private static class MGetAccountClerkResponseTupleScheme extends TupleScheme<MGetAccountClerkResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MGetAccountClerkResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUsers()) {
        {
          ...
          for (top.itcat.rpc.service.model.AccountClerk _iter76 : struct.users)
          {
            _iter76.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MGetAccountClerkResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.users = new ArrayList<top.itcat.rpc.service.model.AccountClerk>(_list77.size);
          top.itcat.rpc.service.model.AccountClerk _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = new top.itcat.rpc.service.model.AccountClerk();
            _elem78.read(iprot);
