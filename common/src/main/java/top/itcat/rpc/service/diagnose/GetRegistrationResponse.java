...
public class GetRegistrationResponse implements org.apache.thrift.TBase<GetRegistrationResponse, GetRegistrationResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetRegistrationResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetRegistrationResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetRegistrationResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetRegistrationResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.Registration> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetRegistrationResponse.class, metaDataMap);
  }
   ...
   */
  public GetRegistrationResponse(GetRegistrationResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.Registration> __this__beanList = new ArrayList<top.itcat.rpc.service.model.Registration>(other.beanList.size());
      for (top.itcat.rpc.service.model.Registration other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.Registration(other_element));
      }
  ...
  public GetRegistrationResponse deepCopy() {
    return new GetRegistrationResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.Registration> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.Registration elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.Registration>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.Registration> getBeanList() {
    return this.beanList;
  }

  public GetRegistrationResponse setBeanList(List<top.itcat.rpc.service.model.Registration> beanList) {
  ...
  public GetRegistrationResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetRegistrationResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.Registration>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetRegistrationResponse)
      return this.equals((GetRegistrationResponse)that);
    return false;
  }

  public boolean equals(GetRegistrationResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetRegistrationResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetRegistrationResponse(");
    boolean first = true;
  ...
  private static class GetRegistrationResponseStandardSchemeFactory implements SchemeFactory {
    public GetRegistrationResponseStandardScheme getScheme() {
      return new GetRegistrationResponseStandardScheme();
    }
  }

  private static class GetRegistrationResponseStandardScheme extends StandardScheme<GetRegistrationResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetRegistrationResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.Registration>(_list128.size);
                top.itcat.rpc.service.model.Registration _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = new top.itcat.rpc.service.model.Registration();
                  _elem129.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetRegistrationResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Registration _iter131 : struct.beanList)
            {
  ...
  private static class GetRegistrationResponseTupleSchemeFactory implements SchemeFactory {
    public GetRegistrationResponseTupleScheme getScheme() {
      return new GetRegistrationResponseTupleScheme();
    }
  }

  private static class GetRegistrationResponseTupleScheme extends TupleScheme<GetRegistrationResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetRegistrationResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.Registration _iter132 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetRegistrationResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.Registration>(_list133.size);
          top.itcat.rpc.service.model.Registration _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new top.itcat.rpc.service.model.Registration();
            _elem134.read(iprot);
