...
public class MGetMedicalDoctorResponse implements org.apache.thrift.TBase<MGetMedicalDoctorResponse, MGetMedicalDoctorResponse._Fields>, java.io.Serializable, Cloneable, Comparable<MGetMedicalDoctorResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MGetMedicalDoctorResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new MGetMedicalDoctorResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MGetMedicalDoctorResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MGetMedicalDoctorResponse.class, metaDataMap);
  }

  public MGetMedicalDoctorResponse() {
  }
   ...
   */
  public MGetMedicalDoctorResponse(MGetMedicalDoctorResponse other) {
  ...
  public MGetMedicalDoctorResponse deepCopy() {
    return new MGetMedicalDoctorResponse(this);
  }
  ...
  public MGetMedicalDoctorResponse setUsers(List<top.itcat.rpc.service.model.MedicalDoctor> users) {
    this.users = users;
    return this;
  }
  ...
  public MGetMedicalDoctorResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public MGetMedicalDoctorResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MGetMedicalDoctorResponse)
      return this.equals((MGetMedicalDoctorResponse)that);
    return false;
  }

  public boolean equals(MGetMedicalDoctorResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MGetMedicalDoctorResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MGetMedicalDoctorResponse(");
    boolean first = true;
  ...
  private static class MGetMedicalDoctorResponseStandardSchemeFactory implements SchemeFactory {
    public MGetMedicalDoctorResponseStandardScheme getScheme() {
      return new MGetMedicalDoctorResponseStandardScheme();
    }
  }

  private static class MGetMedicalDoctorResponseStandardScheme extends StandardScheme<MGetMedicalDoctorResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MGetMedicalDoctorResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<top.itcat.rpc.service.model.MedicalDoctor>(_list192.size);
                top.itcat.rpc.service.model.MedicalDoctor _elem193;
                for (int _i194 = 0; _i194 < _list192.size; ++_i194)
                {
                  _elem193 = new top.itcat.rpc.service.model.MedicalDoctor();
                  _elem193.read(iprot);
                  struct.users.add(_elem193);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MGetMedicalDoctorResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.users != null) {
        if (struct.isSetUsers()) {
          oprot.writeFieldBegin(USERS_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.MedicalDoctor _iter195 : struct.users)
            {
  ...
  private static class MGetMedicalDoctorResponseTupleSchemeFactory implements SchemeFactory {
    public MGetMedicalDoctorResponseTupleScheme getScheme() {
      return new MGetMedicalDoctorResponseTupleScheme();
    }
  }

  private static class MGetMedicalDoctorResponseTupleScheme extends TupleScheme<MGetMedicalDoctorResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MGetMedicalDoctorResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUsers()) {
        {
          ...
          for (top.itcat.rpc.service.model.MedicalDoctor _iter196 : struct.users)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MGetMedicalDoctorResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.users = new ArrayList<top.itcat.rpc.service.model.MedicalDoctor>(_list197.size);
          top.itcat.rpc.service.model.MedicalDoctor _elem198;
          for (int _i199 = 0; _i199 < _list197.size; ++_i199)
          {
            _elem198 = new top.itcat.rpc.service.model.MedicalDoctor();
            _elem198.read(iprot);
            struct.users.add(_elem198);
          }
        }
        struct.setUsersIsSet(true);
      }
