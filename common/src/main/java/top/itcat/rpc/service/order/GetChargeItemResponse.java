...
public class GetChargeItemResponse implements org.apache.thrift.TBase<GetChargeItemResponse, GetChargeItemResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetChargeItemResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetChargeItemResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetChargeItemResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetChargeItemResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetChargeItemResponse.class, metaDataMap);
  }

  public GetChargeItemResponse() {
  }
   ...
   */
  public GetChargeItemResponse(GetChargeItemResponse other) {
  ...
  public GetChargeItemResponse deepCopy() {
    return new GetChargeItemResponse(this);
  }
  ...
  public GetChargeItemResponse setBeanList(List<top.itcat.rpc.service.model.ChargeItem> beanList) {
  ...
  public GetChargeItemResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetChargeItemResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetChargeItemResponse)
      return this.equals((GetChargeItemResponse)that);
    return false;
  }

  public boolean equals(GetChargeItemResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetChargeItemResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetChargeItemResponse(");
    boolean first = true;
  ...
  private static class GetChargeItemResponseStandardSchemeFactory implements SchemeFactory {
    public GetChargeItemResponseStandardScheme getScheme() {
      return new GetChargeItemResponseStandardScheme();
    }
  }

  private static class GetChargeItemResponseStandardScheme extends StandardScheme<GetChargeItemResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetChargeItemResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.ChargeItem>(_list88.size);
                top.itcat.rpc.service.model.ChargeItem _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                {
                  _elem89 = new top.itcat.rpc.service.model.ChargeItem();
                  _elem89.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetChargeItemResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.ChargeItem _iter91 : struct.beanList)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetChargeItemResponseTupleSchemeFactory implements SchemeFactory {
    public GetChargeItemResponseTupleScheme getScheme() {
      return new GetChargeItemResponseTupleScheme();
    }
  }

  private static class GetChargeItemResponseTupleScheme extends TupleScheme<GetChargeItemResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetChargeItemResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.ChargeItem _iter92 : struct.beanList)
          {
            _iter92.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetChargeItemResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.ChargeItem>(_list93.size);
          top.itcat.rpc.service.model.ChargeItem _elem94;
          for (int _i95 = 0; _i95 < _list93.size; ++_i95)
          {
            _elem94 = new top.itcat.rpc.service.model.ChargeItem();
            _elem94.read(iprot);
