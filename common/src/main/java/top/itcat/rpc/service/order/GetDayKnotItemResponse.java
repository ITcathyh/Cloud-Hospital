...
public class GetDayKnotItemResponse implements org.apache.thrift.TBase<GetDayKnotItemResponse, GetDayKnotItemResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetDayKnotItemResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetDayKnotItemResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetDayKnotItemResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetDayKnotItemResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.DayKnotItem> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetDayKnotItemResponse.class, metaDataMap);
  }

  public GetDayKnotItemResponse() {
  }
   ...
   */
  public GetDayKnotItemResponse(GetDayKnotItemResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.DayKnotItem> __this__beanList = new ArrayList<top.itcat.rpc.service.model.DayKnotItem>(other.beanList.size());
      for (top.itcat.rpc.service.model.DayKnotItem other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.DayKnotItem(other_element));
      }
  ...
  public GetDayKnotItemResponse deepCopy() {
    return new GetDayKnotItemResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.DayKnotItem> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.DayKnotItem elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.DayKnotItem>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.DayKnotItem> getBeanList() {
    return this.beanList;
  }

  public GetDayKnotItemResponse setBeanList(List<top.itcat.rpc.service.model.DayKnotItem> beanList) {
  ...
  public GetDayKnotItemResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetDayKnotItemResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.DayKnotItem>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetDayKnotItemResponse)
      return this.equals((GetDayKnotItemResponse)that);
    return false;
  }

  public boolean equals(GetDayKnotItemResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetDayKnotItemResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetDayKnotItemResponse(");
    boolean first = true;
  ...
  private static class GetDayKnotItemResponseStandardSchemeFactory implements SchemeFactory {
    public GetDayKnotItemResponseStandardScheme getScheme() {
      return new GetDayKnotItemResponseStandardScheme();
    }
  }

  private static class GetDayKnotItemResponseStandardScheme extends StandardScheme<GetDayKnotItemResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetDayKnotItemResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.DayKnotItem>(_list64.size);
                top.itcat.rpc.service.model.DayKnotItem _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new top.itcat.rpc.service.model.DayKnotItem();
                  _elem65.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetDayKnotItemResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.DayKnotItem _iter67 : struct.beanList)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetDayKnotItemResponseTupleSchemeFactory implements SchemeFactory {
    public GetDayKnotItemResponseTupleScheme getScheme() {
      return new GetDayKnotItemResponseTupleScheme();
    }
  }

  private static class GetDayKnotItemResponseTupleScheme extends TupleScheme<GetDayKnotItemResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetDayKnotItemResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.DayKnotItem _iter68 : struct.beanList)
          {
            _iter68.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetDayKnotItemResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.DayKnotItem>(_list69.size);
          top.itcat.rpc.service.model.DayKnotItem _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new top.itcat.rpc.service.model.DayKnotItem();
            _elem70.read(iprot);
