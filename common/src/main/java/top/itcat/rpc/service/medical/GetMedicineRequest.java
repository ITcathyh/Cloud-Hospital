...
public class GetMedicineRequest implements org.apache.thrift.TBase<GetMedicineRequest, GetMedicineRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetMedicineRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetMedicineRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetMedicineRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetMedicineRequestTupleSchemeFactory());
  }
   ...
   */
  public top.itcat.rpc.service.model.MedicineCategoryEnum category; // optional
  ...
  private static final _Fields optionals[] = {_Fields.IDS,_Fields.SEARCH_KEY,_Fields.CATEGORY,_Fields.OFFSET,_Fields.LIMIT};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetMedicineRequest.class, metaDataMap);
  }
   ...
   */
  public GetMedicineRequest(GetMedicineRequest other) {
  ...
  public GetMedicineRequest deepCopy() {
    return new GetMedicineRequest(this);
  }
  ...
  public GetMedicineRequest setIds(List<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public GetMedicineRequest setSearchKey(String searchKey) {
   ...
   * @see top.itcat.rpc.service.model.MedicineCategoryEnum
   */
  public top.itcat.rpc.service.model.MedicineCategoryEnum getCategory() {
   ...
   * @see top.itcat.rpc.service.model.MedicineCategoryEnum
   */
  public GetMedicineRequest setCategory(top.itcat.rpc.service.model.MedicineCategoryEnum category) {
  ...
  public GetMedicineRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public GetMedicineRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CATEGORY:
      if (value == null) {
        ...
        setCategory((top.itcat.rpc.service.model.MedicineCategoryEnum)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetMedicineRequest)
      return this.equals((GetMedicineRequest)that);
    return false;
  }

  public boolean equals(GetMedicineRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetMedicineRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetMedicineRequest(");
    boolean first = true;
  ...
  private static class GetMedicineRequestStandardSchemeFactory implements SchemeFactory {
    public GetMedicineRequestStandardScheme getScheme() {
      return new GetMedicineRequestStandardScheme();
    }
  }

  private static class GetMedicineRequestStandardScheme extends StandardScheme<GetMedicineRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetMedicineRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetMedicineRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetMedicineRequestTupleSchemeFactory implements SchemeFactory {
    public GetMedicineRequestTupleScheme getScheme() {
      return new GetMedicineRequestTupleScheme();
    }
  }

  private static class GetMedicineRequestTupleScheme extends TupleScheme<GetMedicineRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetMedicineRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetMedicineRequest struct) throws org.apache.thrift.TException {
