...
public class GetMedicineResponse implements org.apache.thrift.TBase<GetMedicineResponse, GetMedicineResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetMedicineResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetMedicineResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetMedicineResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetMedicineResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetMedicineResponse.class, metaDataMap);
  }
   ...
   */
  public GetMedicineResponse(GetMedicineResponse other) {
  ...
  public GetMedicineResponse deepCopy() {
    return new GetMedicineResponse(this);
  }
  ...
  public GetMedicineResponse setBeanList(List<top.itcat.rpc.service.model.Medicine> beanList) {
  ...
  public GetMedicineResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetMedicineResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetMedicineResponse)
      return this.equals((GetMedicineResponse)that);
    return false;
  }

  public boolean equals(GetMedicineResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetMedicineResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetMedicineResponse(");
    boolean first = true;
  ...
  private static class GetMedicineResponseStandardSchemeFactory implements SchemeFactory {
    public GetMedicineResponseStandardScheme getScheme() {
      return new GetMedicineResponseStandardScheme();
    }
  }

  private static class GetMedicineResponseStandardScheme extends StandardScheme<GetMedicineResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetMedicineResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.Medicine>(_list56.size);
                top.itcat.rpc.service.model.Medicine _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new top.itcat.rpc.service.model.Medicine();
                  _elem57.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetMedicineResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Medicine _iter59 : struct.beanList)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetMedicineResponseTupleSchemeFactory implements SchemeFactory {
    public GetMedicineResponseTupleScheme getScheme() {
      return new GetMedicineResponseTupleScheme();
    }
  }

  private static class GetMedicineResponseTupleScheme extends TupleScheme<GetMedicineResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetMedicineResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.Medicine _iter60 : struct.beanList)
          {
            _iter60.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetMedicineResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.Medicine>(_list61.size);
          top.itcat.rpc.service.model.Medicine _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new top.itcat.rpc.service.model.Medicine();
            _elem62.read(iprot);
