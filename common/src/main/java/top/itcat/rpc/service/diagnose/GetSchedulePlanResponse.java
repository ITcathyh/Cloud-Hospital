...
public class GetSchedulePlanResponse implements org.apache.thrift.TBase<GetSchedulePlanResponse, GetSchedulePlanResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetSchedulePlanResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetSchedulePlanResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetSchedulePlanResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetSchedulePlanResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.SchedulePlan> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetSchedulePlanResponse.class, metaDataMap);
  }

  public GetSchedulePlanResponse() {
  }
   ...
   */
  public GetSchedulePlanResponse(GetSchedulePlanResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.SchedulePlan> __this__beanList = new ArrayList<top.itcat.rpc.service.model.SchedulePlan>(other.beanList.size());
      for (top.itcat.rpc.service.model.SchedulePlan other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.SchedulePlan(other_element));
      }
  ...
  public GetSchedulePlanResponse deepCopy() {
    return new GetSchedulePlanResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.SchedulePlan> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.SchedulePlan elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.SchedulePlan>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.SchedulePlan> getBeanList() {
    return this.beanList;
  }

  public GetSchedulePlanResponse setBeanList(List<top.itcat.rpc.service.model.SchedulePlan> beanList) {
  ...
  public GetSchedulePlanResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetSchedulePlanResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.SchedulePlan>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetSchedulePlanResponse)
      return this.equals((GetSchedulePlanResponse)that);
    return false;
  }

  public boolean equals(GetSchedulePlanResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetSchedulePlanResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetSchedulePlanResponse(");
    boolean first = true;
  ...
  private static class GetSchedulePlanResponseStandardSchemeFactory implements SchemeFactory {
    public GetSchedulePlanResponseStandardScheme getScheme() {
      return new GetSchedulePlanResponseStandardScheme();
    }
  }

  private static class GetSchedulePlanResponseStandardScheme extends StandardScheme<GetSchedulePlanResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetSchedulePlanResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.SchedulePlan>(_list80.size);
                top.itcat.rpc.service.model.SchedulePlan _elem81;
                for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                {
                  _elem81 = new top.itcat.rpc.service.model.SchedulePlan();
                  _elem81.read(iprot);
                  struct.beanList.add(_elem81);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetSchedulePlanResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.SchedulePlan _iter83 : struct.beanList)
            {
              _iter83.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetSchedulePlanResponseTupleSchemeFactory implements SchemeFactory {
    public GetSchedulePlanResponseTupleScheme getScheme() {
      return new GetSchedulePlanResponseTupleScheme();
    }
  }

  private static class GetSchedulePlanResponseTupleScheme extends TupleScheme<GetSchedulePlanResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetSchedulePlanResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.SchedulePlan _iter84 : struct.beanList)
          {
            _iter84.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetSchedulePlanResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.SchedulePlan>(_list85.size);
          top.itcat.rpc.service.model.SchedulePlan _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new top.itcat.rpc.service.model.SchedulePlan();
            _elem86.read(iprot);
            struct.beanList.add(_elem86);
          }
        }
        struct.setBeanListIsSet(true);
      }
