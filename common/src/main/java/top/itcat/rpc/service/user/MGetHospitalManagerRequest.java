...
public class MGetHospitalManagerRequest implements org.apache.thrift.TBase<MGetHospitalManagerRequest, MGetHospitalManagerRequest._Fields>, java.io.Serializable, Cloneable, Comparable<MGetHospitalManagerRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MGetHospitalManagerRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new MGetHospitalManagerRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MGetHospitalManagerRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MGetHospitalManagerRequest.class, metaDataMap);
  }

  public MGetHospitalManagerRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public MGetHospitalManagerRequest(MGetHospitalManagerRequest other) {
  ...
  public MGetHospitalManagerRequest deepCopy() {
    return new MGetHospitalManagerRequest(this);
  }
  ...
  public MGetHospitalManagerRequest setUids(List<Long> uids) {
    this.uids = uids;
    return this;
  }
  ...
  public MGetHospitalManagerRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public MGetHospitalManagerRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public MGetHospitalManagerRequest setSearchKey(String searchKey) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MGetHospitalManagerRequest)
      return this.equals((MGetHospitalManagerRequest)that);
    return false;
  }

  public boolean equals(MGetHospitalManagerRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MGetHospitalManagerRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MGetHospitalManagerRequest(");
    boolean first = true;
  ...
  private static class MGetHospitalManagerRequestStandardSchemeFactory implements SchemeFactory {
    public MGetHospitalManagerRequestStandardScheme getScheme() {
      return new MGetHospitalManagerRequestStandardScheme();
    }
  }

  private static class MGetHospitalManagerRequestStandardScheme extends StandardScheme<MGetHospitalManagerRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MGetHospitalManagerRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uids = new ArrayList<Long>(_list96.size);
                long _elem97;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MGetHospitalManagerRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MGetHospitalManagerRequestTupleSchemeFactory implements SchemeFactory {
    public MGetHospitalManagerRequestTupleScheme getScheme() {
      return new MGetHospitalManagerRequestTupleScheme();
    }
  }

  private static class MGetHospitalManagerRequestTupleScheme extends TupleScheme<MGetHospitalManagerRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MGetHospitalManagerRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MGetHospitalManagerRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.uids = new ArrayList<Long>(_list101.size);
          long _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = iprot.readI64();
            struct.uids.add(_elem102);
          }
        }
        struct.setUidsIsSet(true);
      }
