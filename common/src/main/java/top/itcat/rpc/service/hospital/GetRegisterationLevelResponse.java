...
public class GetRegisterationLevelResponse implements org.apache.thrift.TBase<GetRegisterationLevelResponse, GetRegisterationLevelResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetRegisterationLevelResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetRegisterationLevelResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetRegisterationLevelResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetRegisterationLevelResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.RegisterationLevel> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetRegisterationLevelResponse.class, metaDataMap);
  }

  public GetRegisterationLevelResponse() {
  }
   ...
   */
  public GetRegisterationLevelResponse(GetRegisterationLevelResponse other) {
  ...
  public GetRegisterationLevelResponse deepCopy() {
    return new GetRegisterationLevelResponse(this);
  }
  ...
  public GetRegisterationLevelResponse setBeanList(List<top.itcat.rpc.service.model.RegisterationLevel> beanList) {
  ...
  public GetRegisterationLevelResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetRegisterationLevelResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetRegisterationLevelResponse)
      return this.equals((GetRegisterationLevelResponse)that);
    return false;
  }

  public boolean equals(GetRegisterationLevelResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetRegisterationLevelResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetRegisterationLevelResponse(");
    boolean first = true;
  ...
  private static class GetRegisterationLevelResponseStandardSchemeFactory implements SchemeFactory {
    public GetRegisterationLevelResponseStandardScheme getScheme() {
      return new GetRegisterationLevelResponseStandardScheme();
    }
  }

  private static class GetRegisterationLevelResponseStandardScheme extends StandardScheme<GetRegisterationLevelResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetRegisterationLevelResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.RegisterationLevel>(_list56.size);
                top.itcat.rpc.service.model.RegisterationLevel _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new top.itcat.rpc.service.model.RegisterationLevel();
                  _elem57.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetRegisterationLevelResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.RegisterationLevel _iter59 : struct.beanList)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetRegisterationLevelResponseTupleSchemeFactory implements SchemeFactory {
    public GetRegisterationLevelResponseTupleScheme getScheme() {
      return new GetRegisterationLevelResponseTupleScheme();
    }
  }

  private static class GetRegisterationLevelResponseTupleScheme extends TupleScheme<GetRegisterationLevelResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetRegisterationLevelResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.RegisterationLevel _iter60 : struct.beanList)
          {
            _iter60.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetRegisterationLevelResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.RegisterationLevel>(_list61.size);
          top.itcat.rpc.service.model.RegisterationLevel _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new top.itcat.rpc.service.model.RegisterationLevel();
            _elem62.read(iprot);
