...
public class GetBillingCategoryResponse implements org.apache.thrift.TBase<GetBillingCategoryResponse, GetBillingCategoryResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetBillingCategoryResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetBillingCategoryResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetBillingCategoryResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetBillingCategoryResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.BillingCategory> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetBillingCategoryResponse.class, metaDataMap);
  }

  public GetBillingCategoryResponse() {
  }
   ...
   */
  public GetBillingCategoryResponse(GetBillingCategoryResponse other) {
  ...
  public GetBillingCategoryResponse deepCopy() {
    return new GetBillingCategoryResponse(this);
  }
  ...
  public GetBillingCategoryResponse setBeanList(List<top.itcat.rpc.service.model.BillingCategory> beanList) {
  ...
  public GetBillingCategoryResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetBillingCategoryResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetBillingCategoryResponse)
      return this.equals((GetBillingCategoryResponse)that);
    return false;
  }

  public boolean equals(GetBillingCategoryResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetBillingCategoryResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetBillingCategoryResponse(");
    boolean first = true;
  ...
  private static class GetBillingCategoryResponseStandardSchemeFactory implements SchemeFactory {
    public GetBillingCategoryResponseStandardScheme getScheme() {
      return new GetBillingCategoryResponseStandardScheme();
    }
  }

  private static class GetBillingCategoryResponseStandardScheme extends StandardScheme<GetBillingCategoryResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetBillingCategoryResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.BillingCategory>(_list32.size);
                top.itcat.rpc.service.model.BillingCategory _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new top.itcat.rpc.service.model.BillingCategory();
                  _elem33.read(iprot);
                  struct.beanList.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetBillingCategoryResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.BillingCategory _iter35 : struct.beanList)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetBillingCategoryResponseTupleSchemeFactory implements SchemeFactory {
    public GetBillingCategoryResponseTupleScheme getScheme() {
      return new GetBillingCategoryResponseTupleScheme();
    }
  }

  private static class GetBillingCategoryResponseTupleScheme extends TupleScheme<GetBillingCategoryResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetBillingCategoryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.BillingCategory _iter36 : struct.beanList)
          {
            _iter36.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetBillingCategoryResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.BillingCategory>(_list37.size);
          top.itcat.rpc.service.model.BillingCategory _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new top.itcat.rpc.service.model.BillingCategory();
            _elem38.read(iprot);
            struct.beanList.add(_elem38);
          }
        }
        struct.setBeanListIsSet(true);
      }
