...
public class GetScheduleRuleResponse implements org.apache.thrift.TBase<GetScheduleRuleResponse, GetScheduleRuleResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetScheduleRuleResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetScheduleRuleResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetScheduleRuleResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetScheduleRuleResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetScheduleRuleResponse.class, metaDataMap);
  }

  public GetScheduleRuleResponse() {
  }
   ...
   */
  public GetScheduleRuleResponse(GetScheduleRuleResponse other) {
  ...
  public GetScheduleRuleResponse deepCopy() {
    return new GetScheduleRuleResponse(this);
  }
  ...
  public GetScheduleRuleResponse setBeanList(List<top.itcat.rpc.service.model.ScheduleRule> beanList) {
  ...
  public GetScheduleRuleResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetScheduleRuleResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetScheduleRuleResponse)
      return this.equals((GetScheduleRuleResponse)that);
    return false;
  }

  public boolean equals(GetScheduleRuleResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetScheduleRuleResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetScheduleRuleResponse(");
    boolean first = true;
  ...
  private static class GetScheduleRuleResponseStandardSchemeFactory implements SchemeFactory {
    public GetScheduleRuleResponseStandardScheme getScheme() {
      return new GetScheduleRuleResponseStandardScheme();
    }
  }

  private static class GetScheduleRuleResponseStandardScheme extends StandardScheme<GetScheduleRuleResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetScheduleRuleResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.ScheduleRule>(_list96.size);
                top.itcat.rpc.service.model.ScheduleRule _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = new top.itcat.rpc.service.model.ScheduleRule();
                  _elem97.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetScheduleRuleResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.ScheduleRule _iter99 : struct.beanList)
            {
              _iter99.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetScheduleRuleResponseTupleSchemeFactory implements SchemeFactory {
    public GetScheduleRuleResponseTupleScheme getScheme() {
      return new GetScheduleRuleResponseTupleScheme();
    }
  }

  private static class GetScheduleRuleResponseTupleScheme extends TupleScheme<GetScheduleRuleResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetScheduleRuleResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.ScheduleRule _iter100 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetScheduleRuleResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.ScheduleRule>(_list101.size);
          top.itcat.rpc.service.model.ScheduleRule _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = new top.itcat.rpc.service.model.ScheduleRule();
            _elem102.read(iprot);
