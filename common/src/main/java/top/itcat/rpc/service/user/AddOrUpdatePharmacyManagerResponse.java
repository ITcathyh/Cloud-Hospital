...
public class AddOrUpdatePharmacyManagerResponse implements org.apache.thrift.TBase<AddOrUpdatePharmacyManagerResponse, AddOrUpdatePharmacyManagerResponse._Fields>, java.io.Serializable, Cloneable, Comparable<AddOrUpdatePharmacyManagerResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddOrUpdatePharmacyManagerResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new AddOrUpdatePharmacyManagerResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddOrUpdatePharmacyManagerResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddOrUpdatePharmacyManagerResponse.class, metaDataMap);
  }

  public AddOrUpdatePharmacyManagerResponse() {
  }
   ...
   */
  public AddOrUpdatePharmacyManagerResponse(AddOrUpdatePharmacyManagerResponse other) {
    if (other.isSetUsers()) {
  ...
  public AddOrUpdatePharmacyManagerResponse deepCopy() {
    return new AddOrUpdatePharmacyManagerResponse(this);
  }
  ...
  public AddOrUpdatePharmacyManagerResponse setUsers(List<top.itcat.rpc.service.model.PharmacyManager> users) {
    this.users = users;
    return this;
  }
  ...
  public AddOrUpdatePharmacyManagerResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddOrUpdatePharmacyManagerResponse)
      return this.equals((AddOrUpdatePharmacyManagerResponse)that);
    return false;
  }

  public boolean equals(AddOrUpdatePharmacyManagerResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddOrUpdatePharmacyManagerResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddOrUpdatePharmacyManagerResponse(");
    boolean first = true;
  ...
  private static class AddOrUpdatePharmacyManagerResponseStandardSchemeFactory implements SchemeFactory {
    public AddOrUpdatePharmacyManagerResponseStandardScheme getScheme() {
      return new AddOrUpdatePharmacyManagerResponseStandardScheme();
    }
  }

  private static class AddOrUpdatePharmacyManagerResponseStandardScheme extends StandardScheme<AddOrUpdatePharmacyManagerResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddOrUpdatePharmacyManagerResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<top.itcat.rpc.service.model.PharmacyManager>(_list152.size);
                top.itcat.rpc.service.model.PharmacyManager _elem153;
                for (int _i154 = 0; _i154 < _list152.size; ++_i154)
                {
                  _elem153 = new top.itcat.rpc.service.model.PharmacyManager();
                  _elem153.read(iprot);
                  struct.users.add(_elem153);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddOrUpdatePharmacyManagerResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.users != null) {
        if (struct.isSetUsers()) {
          oprot.writeFieldBegin(USERS_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.PharmacyManager _iter155 : struct.users)
            {
  ...
  private static class AddOrUpdatePharmacyManagerResponseTupleSchemeFactory implements SchemeFactory {
    public AddOrUpdatePharmacyManagerResponseTupleScheme getScheme() {
      return new AddOrUpdatePharmacyManagerResponseTupleScheme();
    }
  }

  private static class AddOrUpdatePharmacyManagerResponseTupleScheme extends TupleScheme<AddOrUpdatePharmacyManagerResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddOrUpdatePharmacyManagerResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUsers()) {
        {
          ...
          for (top.itcat.rpc.service.model.PharmacyManager _iter156 : struct.users)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddOrUpdatePharmacyManagerResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.users = new ArrayList<top.itcat.rpc.service.model.PharmacyManager>(_list157.size);
          top.itcat.rpc.service.model.PharmacyManager _elem158;
          for (int _i159 = 0; _i159 < _list157.size; ++_i159)
          {
            _elem158 = new top.itcat.rpc.service.model.PharmacyManager();
            _elem158.read(iprot);
            struct.users.add(_elem158);
          }
        }
        struct.setUsersIsSet(true);
      }
