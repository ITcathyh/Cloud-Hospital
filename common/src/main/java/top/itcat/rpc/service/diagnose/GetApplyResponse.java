...
public class GetApplyResponse implements org.apache.thrift.TBase<GetApplyResponse, GetApplyResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetApplyResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetApplyResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetApplyResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetApplyResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.Apply> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetApplyResponse.class, metaDataMap);
  }
   ...
   */
  public GetApplyResponse(GetApplyResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.Apply> __this__beanList = new ArrayList<top.itcat.rpc.service.model.Apply>(other.beanList.size());
      for (top.itcat.rpc.service.model.Apply other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.Apply(other_element));
      }
  ...
  public GetApplyResponse deepCopy() {
    return new GetApplyResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.Apply> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.Apply elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.Apply>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.Apply> getBeanList() {
    return this.beanList;
  }

  public GetApplyResponse setBeanList(List<top.itcat.rpc.service.model.Apply> beanList) {
  ...
  public GetApplyResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetApplyResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.Apply>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetApplyResponse)
      return this.equals((GetApplyResponse)that);
    return false;
  }

  public boolean equals(GetApplyResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetApplyResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetApplyResponse(");
    boolean first = true;
  ...
  private static class GetApplyResponseStandardSchemeFactory implements SchemeFactory {
    public GetApplyResponseStandardScheme getScheme() {
      return new GetApplyResponseStandardScheme();
    }
  }

  private static class GetApplyResponseStandardScheme extends StandardScheme<GetApplyResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetApplyResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.Apply>(_list216.size);
                top.itcat.rpc.service.model.Apply _elem217;
                for (int _i218 = 0; _i218 < _list216.size; ++_i218)
                {
                  _elem217 = new top.itcat.rpc.service.model.Apply();
                  _elem217.read(iprot);
                  struct.beanList.add(_elem217);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetApplyResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Apply _iter219 : struct.beanList)
            {
  ...
  private static class GetApplyResponseTupleSchemeFactory implements SchemeFactory {
    public GetApplyResponseTupleScheme getScheme() {
      return new GetApplyResponseTupleScheme();
    }
  }

  private static class GetApplyResponseTupleScheme extends TupleScheme<GetApplyResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetApplyResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.Apply _iter220 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetApplyResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.Apply>(_list221.size);
          top.itcat.rpc.service.model.Apply _elem222;
          for (int _i223 = 0; _i223 < _list221.size; ++_i223)
          {
            _elem222 = new top.itcat.rpc.service.model.Apply();
            _elem222.read(iprot);
            struct.beanList.add(_elem222);
          }
        }
        struct.setBeanListIsSet(true);
      }
