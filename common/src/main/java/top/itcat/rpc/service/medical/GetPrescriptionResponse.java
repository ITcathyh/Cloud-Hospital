...
public class GetPrescriptionResponse implements org.apache.thrift.TBase<GetPrescriptionResponse, GetPrescriptionResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetPrescriptionResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetPrescriptionResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetPrescriptionResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetPrescriptionResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.Prescription> beanList; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BEAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("beanList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, top.itcat.rpc.service.model.Prescription.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetPrescriptionResponse.class, metaDataMap);
  }
   ...
   */
  public GetPrescriptionResponse(GetPrescriptionResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.Prescription> __this__beanList = new ArrayList<top.itcat.rpc.service.model.Prescription>(other.beanList.size());
      for (top.itcat.rpc.service.model.Prescription other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.Prescription(other_element));
      }
  ...
  public GetPrescriptionResponse deepCopy() {
    return new GetPrescriptionResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.Prescription> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.Prescription elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.Prescription>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.Prescription> getBeanList() {
    return this.beanList;
  }

  public GetPrescriptionResponse setBeanList(List<top.itcat.rpc.service.model.Prescription> beanList) {
  ...
  public GetPrescriptionResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetPrescriptionResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.Prescription>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetPrescriptionResponse)
      return this.equals((GetPrescriptionResponse)that);
    return false;
  }

  public boolean equals(GetPrescriptionResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetPrescriptionResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetPrescriptionResponse(");
    boolean first = true;
  ...
  private static class GetPrescriptionResponseStandardSchemeFactory implements SchemeFactory {
    public GetPrescriptionResponseStandardScheme getScheme() {
      return new GetPrescriptionResponseStandardScheme();
    }
  }

  private static class GetPrescriptionResponseStandardScheme extends StandardScheme<GetPrescriptionResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetPrescriptionResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.Prescription>(_list32.size);
                top.itcat.rpc.service.model.Prescription _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new top.itcat.rpc.service.model.Prescription();
                  _elem33.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPrescriptionResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Prescription _iter35 : struct.beanList)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetPrescriptionResponseTupleSchemeFactory implements SchemeFactory {
    public GetPrescriptionResponseTupleScheme getScheme() {
      return new GetPrescriptionResponseTupleScheme();
    }
  }

  private static class GetPrescriptionResponseTupleScheme extends TupleScheme<GetPrescriptionResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.Prescription _iter36 : struct.beanList)
          {
            _iter36.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.Prescription>(_list37.size);
          top.itcat.rpc.service.model.Prescription _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new top.itcat.rpc.service.model.Prescription();
            _elem38.read(iprot);
