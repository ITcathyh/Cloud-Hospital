...
public class GetPrescriptionGroupRequest implements org.apache.thrift.TBase<GetPrescriptionGroupRequest, GetPrescriptionGroupRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPrescriptionGroupRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetPrescriptionGroupRequest");
  ...
  private static final org.apache.thrift.protocol.TField CATALOG_FIELD_DESC = new org.apache.thrift.protocol.TField("catalog", org.apache.thrift.protocol.TType.I32, (short)6);
  ...
  static {
    schemes.put(StandardScheme.class, new GetPrescriptionGroupRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetPrescriptionGroupRequestTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.IDS,_Fields.RANGE,_Fields.CREATER_ID,_Fields.DEPARTMENT_ID,_Fields.SEARCH_KEY,_Fields.CATALOG,_Fields.OFFSET,_Fields.LIMIT};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetPrescriptionGroupRequest.class, metaDataMap);
  }

  public GetPrescriptionGroupRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public GetPrescriptionGroupRequest(GetPrescriptionGroupRequest other) {
  ...
  public GetPrescriptionGroupRequest deepCopy() {
    return new GetPrescriptionGroupRequest(this);
  }
  ...
  public GetPrescriptionGroupRequest setIds(List<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public GetPrescriptionGroupRequest setRange(List<top.itcat.rpc.service.model.SuitableRangeEnum> range) {
    this.range = range;
    return this;
  }
  ...
  public GetPrescriptionGroupRequest setCreaterId(long createrId) {
  ...
  public GetPrescriptionGroupRequest setDepartmentId(long departmentId) {
  ...
  public GetPrescriptionGroupRequest setSearchKey(String searchKey) {
   ...
   * @see top.itcat.rpc.service.model.PrescriptionGroupCatalogEnum
   */
  public GetPrescriptionGroupRequest setCatalog(top.itcat.rpc.service.model.PrescriptionGroupCatalogEnum catalog) {
  ...
  public GetPrescriptionGroupRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public GetPrescriptionGroupRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetPrescriptionGroupRequest)
      return this.equals((GetPrescriptionGroupRequest)that);
    return false;
  }

  public boolean equals(GetPrescriptionGroupRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetPrescriptionGroupRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetPrescriptionGroupRequest(");
    boolean first = true;
  ...
  private static class GetPrescriptionGroupRequestStandardSchemeFactory implements SchemeFactory {
    public GetPrescriptionGroupRequestStandardScheme getScheme() {
      return new GetPrescriptionGroupRequestStandardScheme();
    }
  }

  private static class GetPrescriptionGroupRequestStandardScheme extends StandardScheme<GetPrescriptionGroupRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetPrescriptionGroupRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.range = new ArrayList<top.itcat.rpc.service.model.SuitableRangeEnum>(_list3.size);
                top.itcat.rpc.service.model.SuitableRangeEnum _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = top.itcat.rpc.service.model.SuitableRangeEnum.findByValue(iprot.readI32());
                  struct.range.add(_elem4);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPrescriptionGroupRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.range != null) {
        if (struct.isSetRange()) {
          oprot.writeFieldBegin(RANGE_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.SuitableRangeEnum _iter7 : struct.range)
            {
  ...
  private static class GetPrescriptionGroupRequestTupleSchemeFactory implements SchemeFactory {
    public GetPrescriptionGroupRequestTupleScheme getScheme() {
      return new GetPrescriptionGroupRequestTupleScheme();
    }
  }

  private static class GetPrescriptionGroupRequestTupleScheme extends TupleScheme<GetPrescriptionGroupRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionGroupRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRange()) {
        {
          ...
          for (top.itcat.rpc.service.model.SuitableRangeEnum _iter9 : struct.range)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionGroupRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.range = new ArrayList<top.itcat.rpc.service.model.SuitableRangeEnum>(_list13.size);
          top.itcat.rpc.service.model.SuitableRangeEnum _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = top.itcat.rpc.service.model.SuitableRangeEnum.findByValue(iprot.readI32());
            struct.range.add(_elem14);
          }
        }
        struct.setRangeIsSet(true);
      }
