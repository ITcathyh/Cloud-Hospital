...
public class GetDepartmentResponse implements org.apache.thrift.TBase<GetDepartmentResponse, GetDepartmentResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetDepartmentResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetDepartmentResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetDepartmentResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetDepartmentResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.Department> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetDepartmentResponse.class, metaDataMap);
  }
   ...
   */
  public GetDepartmentResponse(GetDepartmentResponse other) {
  ...
  public GetDepartmentResponse deepCopy() {
  ...
  public GetDepartmentResponse setBeanList(List<top.itcat.rpc.service.model.Department> beanList) {
  ...
  public GetDepartmentResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetDepartmentResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetDepartmentResponse)
      return this.equals((GetDepartmentResponse)that);
    return false;
  }

  public boolean equals(GetDepartmentResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetDepartmentResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetDepartmentResponse(");
    boolean first = true;
  ...
  private static class GetDepartmentResponseStandardSchemeFactory implements SchemeFactory {
    public GetDepartmentResponseStandardScheme getScheme() {
      return new GetDepartmentResponseStandardScheme();
    }
  }

  private static class GetDepartmentResponseStandardScheme extends StandardScheme<GetDepartmentResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetDepartmentResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.Department>(_list8.size);
                top.itcat.rpc.service.model.Department _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new top.itcat.rpc.service.model.Department();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetDepartmentResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Department _iter11 : struct.beanList)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetDepartmentResponseTupleSchemeFactory implements SchemeFactory {
    public GetDepartmentResponseTupleScheme getScheme() {
      return new GetDepartmentResponseTupleScheme();
    }
  }

  private static class GetDepartmentResponseTupleScheme extends TupleScheme<GetDepartmentResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetDepartmentResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.Department _iter12 : struct.beanList)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetDepartmentResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.Department>(_list13.size);
          top.itcat.rpc.service.model.Department _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new top.itcat.rpc.service.model.Department();
            _elem14.read(iprot);
