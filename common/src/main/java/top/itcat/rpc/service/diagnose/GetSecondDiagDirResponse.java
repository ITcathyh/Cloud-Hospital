...
public class GetSecondDiagDirResponse implements org.apache.thrift.TBase<GetSecondDiagDirResponse, GetSecondDiagDirResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetSecondDiagDirResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetSecondDiagDirResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetSecondDiagDirResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetSecondDiagDirResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.SecondDiagDir> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetSecondDiagDirResponse.class, metaDataMap);
  }

  public GetSecondDiagDirResponse() {
  }
   ...
   */
  public GetSecondDiagDirResponse(GetSecondDiagDirResponse other) {
  ...
  public GetSecondDiagDirResponse deepCopy() {
    return new GetSecondDiagDirResponse(this);
  }
  ...
  public GetSecondDiagDirResponse setBeanList(List<top.itcat.rpc.service.model.SecondDiagDir> beanList) {
  ...
  public GetSecondDiagDirResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetSecondDiagDirResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetSecondDiagDirResponse)
      return this.equals((GetSecondDiagDirResponse)that);
    return false;
  }

  public boolean equals(GetSecondDiagDirResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetSecondDiagDirResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetSecondDiagDirResponse(");
    boolean first = true;
  ...
  private static class GetSecondDiagDirResponseStandardSchemeFactory implements SchemeFactory {
    public GetSecondDiagDirResponseStandardScheme getScheme() {
      return new GetSecondDiagDirResponseStandardScheme();
    }
  }

  private static class GetSecondDiagDirResponseStandardScheme extends StandardScheme<GetSecondDiagDirResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetSecondDiagDirResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.SecondDiagDir>(_list32.size);
                top.itcat.rpc.service.model.SecondDiagDir _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new top.itcat.rpc.service.model.SecondDiagDir();
                  _elem33.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetSecondDiagDirResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.SecondDiagDir _iter35 : struct.beanList)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetSecondDiagDirResponseTupleSchemeFactory implements SchemeFactory {
    public GetSecondDiagDirResponseTupleScheme getScheme() {
      return new GetSecondDiagDirResponseTupleScheme();
    }
  }

  private static class GetSecondDiagDirResponseTupleScheme extends TupleScheme<GetSecondDiagDirResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetSecondDiagDirResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.SecondDiagDir _iter36 : struct.beanList)
          {
            _iter36.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetSecondDiagDirResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.SecondDiagDir>(_list37.size);
          top.itcat.rpc.service.model.SecondDiagDir _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new top.itcat.rpc.service.model.SecondDiagDir();
            _elem38.read(iprot);
