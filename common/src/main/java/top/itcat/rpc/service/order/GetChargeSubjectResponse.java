...
public class GetChargeSubjectResponse implements org.apache.thrift.TBase<GetChargeSubjectResponse, GetChargeSubjectResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetChargeSubjectResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetChargeSubjectResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetChargeSubjectResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetChargeSubjectResponseTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.BEAN_LIST,_Fields.TOTAL};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetChargeSubjectResponse.class, metaDataMap);
  }

  public GetChargeSubjectResponse() {
  }
   ...
   */
  public GetChargeSubjectResponse(GetChargeSubjectResponse other) {
  ...
  public GetChargeSubjectResponse deepCopy() {
    return new GetChargeSubjectResponse(this);
  }
  ...
  public GetChargeSubjectResponse setBeanList(List<top.itcat.rpc.service.model.ChargeSubject> beanList) {
  ...
  public GetChargeSubjectResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetChargeSubjectResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetChargeSubjectResponse)
      return this.equals((GetChargeSubjectResponse)that);
    return false;
  }

  public boolean equals(GetChargeSubjectResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetChargeSubjectResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetChargeSubjectResponse(");
    boolean first = true;
  ...
  private static class GetChargeSubjectResponseStandardSchemeFactory implements SchemeFactory {
    public GetChargeSubjectResponseStandardScheme getScheme() {
      return new GetChargeSubjectResponseStandardScheme();
    }
  }

  private static class GetChargeSubjectResponseStandardScheme extends StandardScheme<GetChargeSubjectResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetChargeSubjectResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.ChargeSubject>(_list16.size);
                top.itcat.rpc.service.model.ChargeSubject _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new top.itcat.rpc.service.model.ChargeSubject();
                  _elem17.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetChargeSubjectResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.ChargeSubject _iter19 : struct.beanList)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetChargeSubjectResponseTupleSchemeFactory implements SchemeFactory {
    public GetChargeSubjectResponseTupleScheme getScheme() {
      return new GetChargeSubjectResponseTupleScheme();
    }
  }

  private static class GetChargeSubjectResponseTupleScheme extends TupleScheme<GetChargeSubjectResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetChargeSubjectResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.ChargeSubject _iter20 : struct.beanList)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetChargeSubjectResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.ChargeSubject>(_list21.size);
          top.itcat.rpc.service.model.ChargeSubject _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new top.itcat.rpc.service.model.ChargeSubject();
            _elem22.read(iprot);
