...
public class MGetPharmacyManagerRequest implements org.apache.thrift.TBase<MGetPharmacyManagerRequest, MGetPharmacyManagerRequest._Fields>, java.io.Serializable, Cloneable, Comparable<MGetPharmacyManagerRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MGetPharmacyManagerRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new MGetPharmacyManagerRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MGetPharmacyManagerRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MGetPharmacyManagerRequest.class, metaDataMap);
  }

  public MGetPharmacyManagerRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public MGetPharmacyManagerRequest(MGetPharmacyManagerRequest other) {
  ...
  public MGetPharmacyManagerRequest deepCopy() {
    return new MGetPharmacyManagerRequest(this);
  }
  ...
  public MGetPharmacyManagerRequest setUids(List<Long> uids) {
    this.uids = uids;
    return this;
  }
  ...
  public MGetPharmacyManagerRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public MGetPharmacyManagerRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public MGetPharmacyManagerRequest setSearchKey(String searchKey) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MGetPharmacyManagerRequest)
      return this.equals((MGetPharmacyManagerRequest)that);
    return false;
  }

  public boolean equals(MGetPharmacyManagerRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MGetPharmacyManagerRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MGetPharmacyManagerRequest(");
    boolean first = true;
  ...
  private static class MGetPharmacyManagerRequestStandardSchemeFactory implements SchemeFactory {
    public MGetPharmacyManagerRequestStandardScheme getScheme() {
      return new MGetPharmacyManagerRequestStandardScheme();
    }
  }

  private static class MGetPharmacyManagerRequestStandardScheme extends StandardScheme<MGetPharmacyManagerRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MGetPharmacyManagerRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uids = new ArrayList<Long>(_list128.size);
                long _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = iprot.readI64();
                  struct.uids.add(_elem129);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MGetPharmacyManagerRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MGetPharmacyManagerRequestTupleSchemeFactory implements SchemeFactory {
    public MGetPharmacyManagerRequestTupleScheme getScheme() {
      return new MGetPharmacyManagerRequestTupleScheme();
    }
  }

  private static class MGetPharmacyManagerRequestTupleScheme extends TupleScheme<MGetPharmacyManagerRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MGetPharmacyManagerRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MGetPharmacyManagerRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.uids = new ArrayList<Long>(_list133.size);
          long _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = iprot.readI64();
            struct.uids.add(_elem134);
          }
        }
        struct.setUidsIsSet(true);
      }
