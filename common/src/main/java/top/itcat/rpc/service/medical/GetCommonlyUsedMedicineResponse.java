...
public class GetCommonlyUsedMedicineResponse implements org.apache.thrift.TBase<GetCommonlyUsedMedicineResponse, GetCommonlyUsedMedicineResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetCommonlyUsedMedicineResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetCommonlyUsedMedicineResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetCommonlyUsedMedicineResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetCommonlyUsedMedicineResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetCommonlyUsedMedicineResponse.class, metaDataMap);
  }

  public GetCommonlyUsedMedicineResponse() {
  }
   ...
   */
  public GetCommonlyUsedMedicineResponse(GetCommonlyUsedMedicineResponse other) {
  ...
  public GetCommonlyUsedMedicineResponse deepCopy() {
    return new GetCommonlyUsedMedicineResponse(this);
  }
  ...
  public GetCommonlyUsedMedicineResponse setBeanList(List<top.itcat.rpc.service.model.CommonlyUsedMedicine> beanList) {
  ...
  public GetCommonlyUsedMedicineResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetCommonlyUsedMedicineResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetCommonlyUsedMedicineResponse)
      return this.equals((GetCommonlyUsedMedicineResponse)that);
    return false;
  }

  public boolean equals(GetCommonlyUsedMedicineResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetCommonlyUsedMedicineResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetCommonlyUsedMedicineResponse(");
    boolean first = true;
  ...
  private static class GetCommonlyUsedMedicineResponseStandardSchemeFactory implements SchemeFactory {
    public GetCommonlyUsedMedicineResponseStandardScheme getScheme() {
      return new GetCommonlyUsedMedicineResponseStandardScheme();
    }
  }

  private static class GetCommonlyUsedMedicineResponseStandardScheme extends StandardScheme<GetCommonlyUsedMedicineResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetCommonlyUsedMedicineResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.CommonlyUsedMedicine>(_list146.size);
                top.itcat.rpc.service.model.CommonlyUsedMedicine _elem147;
                for (int _i148 = 0; _i148 < _list146.size; ++_i148)
                {
                  _elem147 = new top.itcat.rpc.service.model.CommonlyUsedMedicine();
                  _elem147.read(iprot);
                  struct.beanList.add(_elem147);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetCommonlyUsedMedicineResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.CommonlyUsedMedicine _iter149 : struct.beanList)
            {
  ...
  private static class GetCommonlyUsedMedicineResponseTupleSchemeFactory implements SchemeFactory {
    public GetCommonlyUsedMedicineResponseTupleScheme getScheme() {
      return new GetCommonlyUsedMedicineResponseTupleScheme();
    }
  }

  private static class GetCommonlyUsedMedicineResponseTupleScheme extends TupleScheme<GetCommonlyUsedMedicineResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetCommonlyUsedMedicineResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.CommonlyUsedMedicine _iter150 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetCommonlyUsedMedicineResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.CommonlyUsedMedicine>(_list151.size);
          top.itcat.rpc.service.model.CommonlyUsedMedicine _elem152;
          for (int _i153 = 0; _i153 < _list151.size; ++_i153)
          {
            _elem152 = new top.itcat.rpc.service.model.CommonlyUsedMedicine();
            _elem152.read(iprot);
            struct.beanList.add(_elem152);
          }
        }
        struct.setBeanListIsSet(true);
      }
