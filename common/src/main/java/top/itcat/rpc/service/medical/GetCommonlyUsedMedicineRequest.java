...
public class GetCommonlyUsedMedicineRequest implements org.apache.thrift.TBase<GetCommonlyUsedMedicineRequest, GetCommonlyUsedMedicineRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetCommonlyUsedMedicineRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetCommonlyUsedMedicineRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetCommonlyUsedMedicineRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetCommonlyUsedMedicineRequestTupleSchemeFactory());
  }
  ...
  /**
   * 
   * @see top.itcat.rpc.service.model.MedicineCategoryEnum
   */
  public top.itcat.rpc.service.model.MedicineCategoryEnum catalog; // optional
  ...
  private static final _Fields optionals[] = {_Fields.IDS,_Fields.RANGE,_Fields.DOCTOR_ID,_Fields.DEPARTMENT_ID,_Fields.CATALOG,_Fields.OFFSET,_Fields.LIMIT};
  ...
  static {
    ...
    tmpMap.put(_Fields.CATALOG, new org.apache.thrift.meta_data.FieldMetaData("catalog", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, top.itcat.rpc.service.model.MedicineCategoryEnum.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetCommonlyUsedMedicineRequest.class, metaDataMap);
  }

  public GetCommonlyUsedMedicineRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public GetCommonlyUsedMedicineRequest(GetCommonlyUsedMedicineRequest other) {
  ...
  public GetCommonlyUsedMedicineRequest deepCopy() {
    return new GetCommonlyUsedMedicineRequest(this);
  }
  ...
  public GetCommonlyUsedMedicineRequest setIds(List<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public GetCommonlyUsedMedicineRequest setRange(List<top.itcat.rpc.service.model.SuitableRangeEnum> range) {
    this.range = range;
    return this;
  }
  ...
  public GetCommonlyUsedMedicineRequest setDoctorId(long doctorId) {
  ...
  public GetCommonlyUsedMedicineRequest setDepartmentId(long departmentId) {
   ...
   * @see top.itcat.rpc.service.model.MedicineCategoryEnum
   */
  public top.itcat.rpc.service.model.MedicineCategoryEnum getCatalog() {
    return this.catalog;
  }
   ...
   * @see top.itcat.rpc.service.model.MedicineCategoryEnum
   */
  public GetCommonlyUsedMedicineRequest setCatalog(top.itcat.rpc.service.model.MedicineCategoryEnum catalog) {
  ...
  public GetCommonlyUsedMedicineRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public GetCommonlyUsedMedicineRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CATALOG:
      if (value == null) {
        ...
        setCatalog((top.itcat.rpc.service.model.MedicineCategoryEnum)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetCommonlyUsedMedicineRequest)
      return this.equals((GetCommonlyUsedMedicineRequest)that);
    return false;
  }

  public boolean equals(GetCommonlyUsedMedicineRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetCommonlyUsedMedicineRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetCommonlyUsedMedicineRequest(");
    boolean first = true;
  ...
  private static class GetCommonlyUsedMedicineRequestStandardSchemeFactory implements SchemeFactory {
    public GetCommonlyUsedMedicineRequestStandardScheme getScheme() {
      return new GetCommonlyUsedMedicineRequestStandardScheme();
    }
  }

  private static class GetCommonlyUsedMedicineRequestStandardScheme extends StandardScheme<GetCommonlyUsedMedicineRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetCommonlyUsedMedicineRequest struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.range = new ArrayList<top.itcat.rpc.service.model.SuitableRangeEnum>(_list133.size);
                top.itcat.rpc.service.model.SuitableRangeEnum _elem134;
                for (int _i135 = 0; _i135 < _list133.size; ++_i135)
                {
                  _elem134 = top.itcat.rpc.service.model.SuitableRangeEnum.findByValue(iprot.readI32());
                  struct.range.add(_elem134);
                }
                iprot.readListEnd();
              }
          ...
          case 5: // CATALOG
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.catalog = top.itcat.rpc.service.model.MedicineCategoryEnum.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetCommonlyUsedMedicineRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.range != null) {
        if (struct.isSetRange()) {
          oprot.writeFieldBegin(RANGE_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.SuitableRangeEnum _iter137 : struct.range)
            {
  ...
  private static class GetCommonlyUsedMedicineRequestTupleSchemeFactory implements SchemeFactory {
    public GetCommonlyUsedMedicineRequestTupleScheme getScheme() {
      return new GetCommonlyUsedMedicineRequestTupleScheme();
    }
  }

  private static class GetCommonlyUsedMedicineRequestTupleScheme extends TupleScheme<GetCommonlyUsedMedicineRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetCommonlyUsedMedicineRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRange()) {
        {
          ...
          for (top.itcat.rpc.service.model.SuitableRangeEnum _iter139 : struct.range)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetCommonlyUsedMedicineRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(7);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list140 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.ids = new ArrayList<Long>(_list140.size);
          long _elem141;
          for (int _i142 = 0; _i142 < _list140.size; ++_i142)
          {
            _elem141 = iprot.readI64();
            struct.ids.add(_elem141);
          }
        }
        struct.setIdsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.range = new ArrayList<top.itcat.rpc.service.model.SuitableRangeEnum>(_list143.size);
          top.itcat.rpc.service.model.SuitableRangeEnum _elem144;
          for (int _i145 = 0; _i145 < _list143.size; ++_i145)
          {
            _elem144 = top.itcat.rpc.service.model.SuitableRangeEnum.findByValue(iprot.readI32());
            struct.range.add(_elem144);
          }
        }
        struct.setRangeIsSet(true);
      }
