...
public class GetFirstDiagDirResponse implements org.apache.thrift.TBase<GetFirstDiagDirResponse, GetFirstDiagDirResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetFirstDiagDirResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetFirstDiagDirResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetFirstDiagDirResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetFirstDiagDirResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.FirstDiagDir> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetFirstDiagDirResponse.class, metaDataMap);
  }

  public GetFirstDiagDirResponse() {
  }
   ...
   */
  public GetFirstDiagDirResponse(GetFirstDiagDirResponse other) {
  ...
  public GetFirstDiagDirResponse deepCopy() {
    return new GetFirstDiagDirResponse(this);
  }
  ...
  public GetFirstDiagDirResponse setBeanList(List<top.itcat.rpc.service.model.FirstDiagDir> beanList) {
  ...
  public GetFirstDiagDirResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetFirstDiagDirResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetFirstDiagDirResponse)
      return this.equals((GetFirstDiagDirResponse)that);
    return false;
  }

  public boolean equals(GetFirstDiagDirResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetFirstDiagDirResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetFirstDiagDirResponse(");
    boolean first = true;
  ...
  private static class GetFirstDiagDirResponseStandardSchemeFactory implements SchemeFactory {
    public GetFirstDiagDirResponseStandardScheme getScheme() {
      return new GetFirstDiagDirResponseStandardScheme();
    }
  }

  private static class GetFirstDiagDirResponseStandardScheme extends StandardScheme<GetFirstDiagDirResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetFirstDiagDirResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.FirstDiagDir>(_list8.size);
                top.itcat.rpc.service.model.FirstDiagDir _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new top.itcat.rpc.service.model.FirstDiagDir();
                  _elem9.read(iprot);
                  struct.beanList.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetFirstDiagDirResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.FirstDiagDir _iter11 : struct.beanList)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetFirstDiagDirResponseTupleSchemeFactory implements SchemeFactory {
    public GetFirstDiagDirResponseTupleScheme getScheme() {
      return new GetFirstDiagDirResponseTupleScheme();
    }
  }

  private static class GetFirstDiagDirResponseTupleScheme extends TupleScheme<GetFirstDiagDirResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetFirstDiagDirResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.FirstDiagDir _iter12 : struct.beanList)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetFirstDiagDirResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.FirstDiagDir>(_list13.size);
          top.itcat.rpc.service.model.FirstDiagDir _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new top.itcat.rpc.service.model.FirstDiagDir();
            _elem14.read(iprot);
            struct.beanList.add(_elem14);
          }
        }
        struct.setBeanListIsSet(true);
      }
