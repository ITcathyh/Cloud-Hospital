...
public class GetMedicalRecordTemplateResponse implements org.apache.thrift.TBase<GetMedicalRecordTemplateResponse, GetMedicalRecordTemplateResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetMedicalRecordTemplateResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetMedicalRecordTemplateResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetMedicalRecordTemplateResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetMedicalRecordTemplateResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.MedicalRecordTemplate> beanList; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BEAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("beanList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, top.itcat.rpc.service.model.MedicalRecordTemplate.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetMedicalRecordTemplateResponse.class, metaDataMap);
  }

  public GetMedicalRecordTemplateResponse() {
  }
   ...
   */
  public GetMedicalRecordTemplateResponse(GetMedicalRecordTemplateResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.MedicalRecordTemplate> __this__beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecordTemplate>(other.beanList.size());
      for (top.itcat.rpc.service.model.MedicalRecordTemplate other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.MedicalRecordTemplate(other_element));
      }
  ...
  public GetMedicalRecordTemplateResponse deepCopy() {
    return new GetMedicalRecordTemplateResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.MedicalRecordTemplate> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.MedicalRecordTemplate elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecordTemplate>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.MedicalRecordTemplate> getBeanList() {
    return this.beanList;
  }

  public GetMedicalRecordTemplateResponse setBeanList(List<top.itcat.rpc.service.model.MedicalRecordTemplate> beanList) {
  ...
  public GetMedicalRecordTemplateResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetMedicalRecordTemplateResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.MedicalRecordTemplate>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetMedicalRecordTemplateResponse)
      return this.equals((GetMedicalRecordTemplateResponse)that);
    return false;
  }

  public boolean equals(GetMedicalRecordTemplateResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetMedicalRecordTemplateResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetMedicalRecordTemplateResponse(");
    boolean first = true;
  ...
  private static class GetMedicalRecordTemplateResponseStandardSchemeFactory implements SchemeFactory {
    public GetMedicalRecordTemplateResponseStandardScheme getScheme() {
      return new GetMedicalRecordTemplateResponseStandardScheme();
    }
  }

  private static class GetMedicalRecordTemplateResponseStandardScheme extends StandardScheme<GetMedicalRecordTemplateResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetMedicalRecordTemplateResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecordTemplate>(_list168.size);
                top.itcat.rpc.service.model.MedicalRecordTemplate _elem169;
                for (int _i170 = 0; _i170 < _list168.size; ++_i170)
                {
                  _elem169 = new top.itcat.rpc.service.model.MedicalRecordTemplate();
                  _elem169.read(iprot);
                  struct.beanList.add(_elem169);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetMedicalRecordTemplateResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.MedicalRecordTemplate _iter171 : struct.beanList)
            {
  ...
  private static class GetMedicalRecordTemplateResponseTupleSchemeFactory implements SchemeFactory {
    public GetMedicalRecordTemplateResponseTupleScheme getScheme() {
      return new GetMedicalRecordTemplateResponseTupleScheme();
    }
  }

  private static class GetMedicalRecordTemplateResponseTupleScheme extends TupleScheme<GetMedicalRecordTemplateResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetMedicalRecordTemplateResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.MedicalRecordTemplate _iter172 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetMedicalRecordTemplateResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecordTemplate>(_list173.size);
          top.itcat.rpc.service.model.MedicalRecordTemplate _elem174;
          for (int _i175 = 0; _i175 < _list173.size; ++_i175)
          {
            _elem174 = new top.itcat.rpc.service.model.MedicalRecordTemplate();
            _elem174.read(iprot);
            struct.beanList.add(_elem174);
          }
        }
        struct.setBeanListIsSet(true);
      }
