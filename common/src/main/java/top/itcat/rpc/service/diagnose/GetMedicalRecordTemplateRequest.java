...
public class GetMedicalRecordTemplateRequest implements org.apache.thrift.TBase<GetMedicalRecordTemplateRequest, GetMedicalRecordTemplateRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetMedicalRecordTemplateRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetMedicalRecordTemplateRequest");
  ...
  private static final org.apache.thrift.protocol.TField SEARCH_KEY_FIELD_DESC = new org.apache.thrift.protocol.TField("searchKey", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  static {
    schemes.put(StandardScheme.class, new GetMedicalRecordTemplateRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetMedicalRecordTemplateRequestTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.IDS,_Fields.RANGE,_Fields.DOCTOR_ID,_Fields.SEARCH_KEY,_Fields.DEPARTMENT_ID,_Fields.OFFSET,_Fields.LIMIT};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetMedicalRecordTemplateRequest.class, metaDataMap);
  }

  public GetMedicalRecordTemplateRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public GetMedicalRecordTemplateRequest(GetMedicalRecordTemplateRequest other) {
  ...
  public GetMedicalRecordTemplateRequest deepCopy() {
    return new GetMedicalRecordTemplateRequest(this);
  }
  ...
  public GetMedicalRecordTemplateRequest setIds(List<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public GetMedicalRecordTemplateRequest setRange(List<top.itcat.rpc.service.model.SuitableRangeEnum> range) {
    this.range = range;
    return this;
  }
  ...
  public GetMedicalRecordTemplateRequest setDoctorId(long doctorId) {
  ...
  public GetMedicalRecordTemplateRequest setSearchKey(String searchKey) {
  ...
  public GetMedicalRecordTemplateRequest setDepartmentId(long departmentId) {
  ...
  public GetMedicalRecordTemplateRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public GetMedicalRecordTemplateRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetMedicalRecordTemplateRequest)
      return this.equals((GetMedicalRecordTemplateRequest)that);
    return false;
  }

  public boolean equals(GetMedicalRecordTemplateRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetMedicalRecordTemplateRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetMedicalRecordTemplateRequest(");
    boolean first = true;
  ...
  private static class GetMedicalRecordTemplateRequestStandardSchemeFactory implements SchemeFactory {
    public GetMedicalRecordTemplateRequestStandardScheme getScheme() {
      return new GetMedicalRecordTemplateRequestStandardScheme();
    }
  }

  private static class GetMedicalRecordTemplateRequestStandardScheme extends StandardScheme<GetMedicalRecordTemplateRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetMedicalRecordTemplateRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new ArrayList<Long>(_list152.size);
                long _elem153;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.range = new ArrayList<top.itcat.rpc.service.model.SuitableRangeEnum>(_list155.size);
                top.itcat.rpc.service.model.SuitableRangeEnum _elem156;
                for (int _i157 = 0; _i157 < _list155.size; ++_i157)
                {
                  _elem156 = top.itcat.rpc.service.model.SuitableRangeEnum.findByValue(iprot.readI32());
                  struct.range.add(_elem156);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetMedicalRecordTemplateRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.range != null) {
        if (struct.isSetRange()) {
          oprot.writeFieldBegin(RANGE_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.SuitableRangeEnum _iter159 : struct.range)
            {
  ...
  private static class GetMedicalRecordTemplateRequestTupleSchemeFactory implements SchemeFactory {
    public GetMedicalRecordTemplateRequestTupleScheme getScheme() {
      return new GetMedicalRecordTemplateRequestTupleScheme();
    }
  }

  private static class GetMedicalRecordTemplateRequestTupleScheme extends TupleScheme<GetMedicalRecordTemplateRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetMedicalRecordTemplateRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRange()) {
        {
          ...
          for (top.itcat.rpc.service.model.SuitableRangeEnum _iter161 : struct.range)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetMedicalRecordTemplateRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.ids = new ArrayList<Long>(_list162.size);
          long _elem163;
          for (int _i164 = 0; _i164 < _list162.size; ++_i164)
          {
            _elem163 = iprot.readI64();
            struct.ids.add(_elem163);
          }
        }
        struct.setIdsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.range = new ArrayList<top.itcat.rpc.service.model.SuitableRangeEnum>(_list165.size);
          top.itcat.rpc.service.model.SuitableRangeEnum _elem166;
          for (int _i167 = 0; _i167 < _list165.size; ++_i167)
          {
            _elem166 = top.itcat.rpc.service.model.SuitableRangeEnum.findByValue(iprot.readI32());
            struct.range.add(_elem166);
          }
        }
        struct.setRangeIsSet(true);
      }
