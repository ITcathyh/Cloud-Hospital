...
public class PayChargeRequest implements org.apache.thrift.TBase<PayChargeRequest, PayChargeRequest._Fields>, java.io.Serializable, Cloneable, Comparable<PayChargeRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PayChargeRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new PayChargeRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PayChargeRequestTupleSchemeFactory());
  }

  public long operatorId; // required
  public long medicalRecordNo; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.MEDICAL_RECORD_NO, new org.apache.thrift.meta_data.FieldMetaData("medicalRecordNo", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PayChargeRequest.class, metaDataMap);
  }

  public PayChargeRequest() {
  }
   ...
   */
  public PayChargeRequest(PayChargeRequest other) {
    __isset_bitfield = other.__isset_bitfield;
    this.operatorId = other.operatorId;
    this.medicalRecordNo = other.medicalRecordNo;
  }

  public PayChargeRequest deepCopy() {
    return new PayChargeRequest(this);
  }
  ...
  public PayChargeRequest setOperatorId(long operatorId) {
    this.operatorId = operatorId;
    setOperatorIdIsSet(true);
    return this;
  }
  ...
  public PayChargeRequest setMedicalRecordNo(long medicalRecordNo) {
    this.medicalRecordNo = medicalRecordNo;
    setMedicalRecordNoIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PayChargeRequest)
      return this.equals((PayChargeRequest)that);
    return false;
  }

  public boolean equals(PayChargeRequest that) {
    if (that == null)
      return false;
    ...
    boolean this_present_medicalRecordNo = true;
    boolean that_present_medicalRecordNo = true;
  ...
  public int hashCode() {
    ...
    boolean present_medicalRecordNo = true;
  ...
  @Override
  public int compareTo(PayChargeRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PayChargeRequest(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'medicalRecordNo' because it's a primitive and you chose the non-beans generator.
  ...
  private static class PayChargeRequestStandardSchemeFactory implements SchemeFactory {
    public PayChargeRequestStandardScheme getScheme() {
      return new PayChargeRequestStandardScheme();
    }
  }

  private static class PayChargeRequestStandardScheme extends StandardScheme<PayChargeRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PayChargeRequest struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetMedicalRecordNo()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'medicalRecordNo' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, PayChargeRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PayChargeRequestTupleSchemeFactory implements SchemeFactory {
    public PayChargeRequestTupleScheme getScheme() {
      return new PayChargeRequestTupleScheme();
    }
  }

  private static class PayChargeRequestTupleScheme extends TupleScheme<PayChargeRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PayChargeRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PayChargeRequest struct) throws org.apache.thrift.TException {
