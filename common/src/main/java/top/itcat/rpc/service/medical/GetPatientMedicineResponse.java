...
public class GetPatientMedicineResponse implements org.apache.thrift.TBase<GetPatientMedicineResponse, GetPatientMedicineResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetPatientMedicineResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetPatientMedicineResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetPatientMedicineResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetPatientMedicineResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.Medicine> beanList; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BEAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("beanList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, top.itcat.rpc.service.model.Medicine.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetPatientMedicineResponse.class, metaDataMap);
  }

  public GetPatientMedicineResponse() {
  }
   ...
   */
  public GetPatientMedicineResponse(GetPatientMedicineResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.Medicine> __this__beanList = new ArrayList<top.itcat.rpc.service.model.Medicine>(other.beanList.size());
      for (top.itcat.rpc.service.model.Medicine other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.Medicine(other_element));
      }
  ...
  public GetPatientMedicineResponse deepCopy() {
    return new GetPatientMedicineResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.Medicine> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.Medicine elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.Medicine>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.Medicine> getBeanList() {
    return this.beanList;
  }

  public GetPatientMedicineResponse setBeanList(List<top.itcat.rpc.service.model.Medicine> beanList) {
  ...
  public GetPatientMedicineResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetPatientMedicineResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.Medicine>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetPatientMedicineResponse)
      return this.equals((GetPatientMedicineResponse)that);
    return false;
  }

  public boolean equals(GetPatientMedicineResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetPatientMedicineResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetPatientMedicineResponse(");
    boolean first = true;
  ...
  private static class GetPatientMedicineResponseStandardSchemeFactory implements SchemeFactory {
    public GetPatientMedicineResponseStandardScheme getScheme() {
      return new GetPatientMedicineResponseStandardScheme();
    }
  }

  private static class GetPatientMedicineResponseStandardScheme extends StandardScheme<GetPatientMedicineResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetPatientMedicineResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.Medicine>(_list64.size);
                top.itcat.rpc.service.model.Medicine _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new top.itcat.rpc.service.model.Medicine();
                  _elem65.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPatientMedicineResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Medicine _iter67 : struct.beanList)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetPatientMedicineResponseTupleSchemeFactory implements SchemeFactory {
    public GetPatientMedicineResponseTupleScheme getScheme() {
      return new GetPatientMedicineResponseTupleScheme();
    }
  }

  private static class GetPatientMedicineResponseTupleScheme extends TupleScheme<GetPatientMedicineResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetPatientMedicineResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.Medicine _iter68 : struct.beanList)
          {
            _iter68.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPatientMedicineResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.Medicine>(_list69.size);
          top.itcat.rpc.service.model.Medicine _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new top.itcat.rpc.service.model.Medicine();
            _elem70.read(iprot);
