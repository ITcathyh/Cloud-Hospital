...
public class GetApplyGroupResponse implements org.apache.thrift.TBase<GetApplyGroupResponse, GetApplyGroupResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetApplyGroupResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetApplyGroupResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetApplyGroupResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetApplyGroupResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.ApplyGroup> beanList; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BEAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("beanList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, top.itcat.rpc.service.model.ApplyGroup.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetApplyGroupResponse.class, metaDataMap);
  }

  public GetApplyGroupResponse() {
  }
   ...
   */
  public GetApplyGroupResponse(GetApplyGroupResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.ApplyGroup> __this__beanList = new ArrayList<top.itcat.rpc.service.model.ApplyGroup>(other.beanList.size());
      for (top.itcat.rpc.service.model.ApplyGroup other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.ApplyGroup(other_element));
      }
  ...
  public GetApplyGroupResponse deepCopy() {
    return new GetApplyGroupResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.ApplyGroup> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.ApplyGroup elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.ApplyGroup>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.ApplyGroup> getBeanList() {
    return this.beanList;
  }

  public GetApplyGroupResponse setBeanList(List<top.itcat.rpc.service.model.ApplyGroup> beanList) {
  ...
  public GetApplyGroupResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetApplyGroupResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.ApplyGroup>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetApplyGroupResponse)
      return this.equals((GetApplyGroupResponse)that);
    return false;
  }

  public boolean equals(GetApplyGroupResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetApplyGroupResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetApplyGroupResponse(");
    boolean first = true;
  ...
  private static class GetApplyGroupResponseStandardSchemeFactory implements SchemeFactory {
    public GetApplyGroupResponseStandardScheme getScheme() {
      return new GetApplyGroupResponseStandardScheme();
    }
  }

  private static class GetApplyGroupResponseStandardScheme extends StandardScheme<GetApplyGroupResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetApplyGroupResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.ApplyGroup>(_list240.size);
                top.itcat.rpc.service.model.ApplyGroup _elem241;
                for (int _i242 = 0; _i242 < _list240.size; ++_i242)
                {
                  _elem241 = new top.itcat.rpc.service.model.ApplyGroup();
                  _elem241.read(iprot);
                  struct.beanList.add(_elem241);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetApplyGroupResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.ApplyGroup _iter243 : struct.beanList)
            {
  ...
  private static class GetApplyGroupResponseTupleSchemeFactory implements SchemeFactory {
    public GetApplyGroupResponseTupleScheme getScheme() {
      return new GetApplyGroupResponseTupleScheme();
    }
  }

  private static class GetApplyGroupResponseTupleScheme extends TupleScheme<GetApplyGroupResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetApplyGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.ApplyGroup _iter244 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetApplyGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.ApplyGroup>(_list245.size);
          top.itcat.rpc.service.model.ApplyGroup _elem246;
          for (int _i247 = 0; _i247 < _list245.size; ++_i247)
          {
            _elem246 = new top.itcat.rpc.service.model.ApplyGroup();
            _elem246.read(iprot);
            struct.beanList.add(_elem246);
          }
        }
        struct.setBeanListIsSet(true);
      }
