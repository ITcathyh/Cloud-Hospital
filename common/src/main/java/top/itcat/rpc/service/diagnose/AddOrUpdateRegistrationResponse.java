...
public class AddOrUpdateRegistrationResponse implements org.apache.thrift.TBase<AddOrUpdateRegistrationResponse, AddOrUpdateRegistrationResponse._Fields>, java.io.Serializable, Cloneable, Comparable<AddOrUpdateRegistrationResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddOrUpdateRegistrationResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new AddOrUpdateRegistrationResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddOrUpdateRegistrationResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddOrUpdateRegistrationResponse.class, metaDataMap);
  }

  public AddOrUpdateRegistrationResponse() {
  }
   ...
   */
  public AddOrUpdateRegistrationResponse(AddOrUpdateRegistrationResponse other) {
    if (other.isSetBean()) {
  ...
  public AddOrUpdateRegistrationResponse deepCopy() {
    return new AddOrUpdateRegistrationResponse(this);
  }
  ...
  public AddOrUpdateRegistrationResponse setBean(top.itcat.rpc.service.model.Registration bean) {
    this.bean = bean;
    return this;
  }
  ...
  public AddOrUpdateRegistrationResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddOrUpdateRegistrationResponse)
      return this.equals((AddOrUpdateRegistrationResponse)that);
    return false;
  }

  public boolean equals(AddOrUpdateRegistrationResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddOrUpdateRegistrationResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddOrUpdateRegistrationResponse(");
    boolean first = true;
  ...
  private static class AddOrUpdateRegistrationResponseStandardSchemeFactory implements SchemeFactory {
    public AddOrUpdateRegistrationResponseStandardScheme getScheme() {
      return new AddOrUpdateRegistrationResponseStandardScheme();
    }
  }

  private static class AddOrUpdateRegistrationResponseStandardScheme extends StandardScheme<AddOrUpdateRegistrationResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddOrUpdateRegistrationResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddOrUpdateRegistrationResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AddOrUpdateRegistrationResponseTupleSchemeFactory implements SchemeFactory {
    public AddOrUpdateRegistrationResponseTupleScheme getScheme() {
      return new AddOrUpdateRegistrationResponseTupleScheme();
    }
  }

  private static class AddOrUpdateRegistrationResponseTupleScheme extends TupleScheme<AddOrUpdateRegistrationResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddOrUpdateRegistrationResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddOrUpdateRegistrationResponse struct) throws org.apache.thrift.TException {
