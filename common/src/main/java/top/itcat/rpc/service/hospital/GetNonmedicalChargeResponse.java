...
public class GetNonmedicalChargeResponse implements org.apache.thrift.TBase<GetNonmedicalChargeResponse, GetNonmedicalChargeResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetNonmedicalChargeResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetNonmedicalChargeResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetNonmedicalChargeResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetNonmedicalChargeResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.NonmedicalCharge> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetNonmedicalChargeResponse.class, metaDataMap);
  }

  public GetNonmedicalChargeResponse() {
  }
   ...
   */
  public GetNonmedicalChargeResponse(GetNonmedicalChargeResponse other) {
  ...
  public GetNonmedicalChargeResponse deepCopy() {
    return new GetNonmedicalChargeResponse(this);
  }
  ...
  public GetNonmedicalChargeResponse setBeanList(List<top.itcat.rpc.service.model.NonmedicalCharge> beanList) {
  ...
  public GetNonmedicalChargeResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetNonmedicalChargeResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetNonmedicalChargeResponse)
      return this.equals((GetNonmedicalChargeResponse)that);
    return false;
  }

  public boolean equals(GetNonmedicalChargeResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetNonmedicalChargeResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetNonmedicalChargeResponse(");
    boolean first = true;
  ...
  private static class GetNonmedicalChargeResponseStandardSchemeFactory implements SchemeFactory {
    public GetNonmedicalChargeResponseStandardScheme getScheme() {
      return new GetNonmedicalChargeResponseStandardScheme();
    }
  }

  private static class GetNonmedicalChargeResponseStandardScheme extends StandardScheme<GetNonmedicalChargeResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetNonmedicalChargeResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.NonmedicalCharge>(_list88.size);
                top.itcat.rpc.service.model.NonmedicalCharge _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                {
                  _elem89 = new top.itcat.rpc.service.model.NonmedicalCharge();
                  _elem89.read(iprot);
                  struct.beanList.add(_elem89);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetNonmedicalChargeResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.NonmedicalCharge _iter91 : struct.beanList)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetNonmedicalChargeResponseTupleSchemeFactory implements SchemeFactory {
    public GetNonmedicalChargeResponseTupleScheme getScheme() {
      return new GetNonmedicalChargeResponseTupleScheme();
    }
  }

  private static class GetNonmedicalChargeResponseTupleScheme extends TupleScheme<GetNonmedicalChargeResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetNonmedicalChargeResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.NonmedicalCharge _iter92 : struct.beanList)
          {
            _iter92.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetNonmedicalChargeResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.NonmedicalCharge>(_list93.size);
          top.itcat.rpc.service.model.NonmedicalCharge _elem94;
          for (int _i95 = 0; _i95 < _list93.size; ++_i95)
          {
            _elem94 = new top.itcat.rpc.service.model.NonmedicalCharge();
            _elem94.read(iprot);
            struct.beanList.add(_elem94);
          }
        }
        struct.setBeanListIsSet(true);
      }
