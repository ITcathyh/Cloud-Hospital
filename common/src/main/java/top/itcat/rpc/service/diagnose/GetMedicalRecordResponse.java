...
public class GetMedicalRecordResponse implements org.apache.thrift.TBase<GetMedicalRecordResponse, GetMedicalRecordResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetMedicalRecordResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetMedicalRecordResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetMedicalRecordResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetMedicalRecordResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.MedicalRecord> beanList; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BEAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("beanList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, top.itcat.rpc.service.model.MedicalRecord.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetMedicalRecordResponse.class, metaDataMap);
  }

  public GetMedicalRecordResponse() {
  }
   ...
   */
  public GetMedicalRecordResponse(GetMedicalRecordResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.MedicalRecord> __this__beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecord>(other.beanList.size());
      for (top.itcat.rpc.service.model.MedicalRecord other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.MedicalRecord(other_element));
      }
  ...
  public GetMedicalRecordResponse deepCopy() {
    return new GetMedicalRecordResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.MedicalRecord> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.MedicalRecord elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecord>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.MedicalRecord> getBeanList() {
    return this.beanList;
  }

  public GetMedicalRecordResponse setBeanList(List<top.itcat.rpc.service.model.MedicalRecord> beanList) {
  ...
  public GetMedicalRecordResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetMedicalRecordResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.MedicalRecord>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetMedicalRecordResponse)
      return this.equals((GetMedicalRecordResponse)that);
    return false;
  }

  public boolean equals(GetMedicalRecordResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetMedicalRecordResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetMedicalRecordResponse(");
    boolean first = true;
  ...
  private static class GetMedicalRecordResponseStandardSchemeFactory implements SchemeFactory {
    public GetMedicalRecordResponseStandardScheme getScheme() {
      return new GetMedicalRecordResponseStandardScheme();
    }
  }

  private static class GetMedicalRecordResponseStandardScheme extends StandardScheme<GetMedicalRecordResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetMedicalRecordResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecord>(_list144.size);
                top.itcat.rpc.service.model.MedicalRecord _elem145;
                for (int _i146 = 0; _i146 < _list144.size; ++_i146)
                {
                  _elem145 = new top.itcat.rpc.service.model.MedicalRecord();
                  _elem145.read(iprot);
                  struct.beanList.add(_elem145);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetMedicalRecordResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.MedicalRecord _iter147 : struct.beanList)
            {
  ...
  private static class GetMedicalRecordResponseTupleSchemeFactory implements SchemeFactory {
    public GetMedicalRecordResponseTupleScheme getScheme() {
      return new GetMedicalRecordResponseTupleScheme();
    }
  }

  private static class GetMedicalRecordResponseTupleScheme extends TupleScheme<GetMedicalRecordResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetMedicalRecordResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.MedicalRecord _iter148 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetMedicalRecordResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.MedicalRecord>(_list149.size);
          top.itcat.rpc.service.model.MedicalRecord _elem150;
          for (int _i151 = 0; _i151 < _list149.size; ++_i151)
          {
            _elem150 = new top.itcat.rpc.service.model.MedicalRecord();
            _elem150.read(iprot);
            struct.beanList.add(_elem150);
          }
        }
        struct.setBeanListIsSet(true);
      }
