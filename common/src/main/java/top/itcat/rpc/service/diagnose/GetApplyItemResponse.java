...
public class GetApplyItemResponse implements org.apache.thrift.TBase<GetApplyItemResponse, GetApplyItemResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetApplyItemResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetApplyItemResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetApplyItemResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetApplyItemResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.ApplyItem> beanList; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetApplyItemResponse.class, metaDataMap);
  }

  public GetApplyItemResponse() {
  }
   ...
   */
  public GetApplyItemResponse(GetApplyItemResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.ApplyItem> __this__beanList = new ArrayList<top.itcat.rpc.service.model.ApplyItem>(other.beanList.size());
      for (top.itcat.rpc.service.model.ApplyItem other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.ApplyItem(other_element));
      }
  ...
  public GetApplyItemResponse deepCopy() {
    return new GetApplyItemResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.ApplyItem> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.ApplyItem elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.ApplyItem>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.ApplyItem> getBeanList() {
    return this.beanList;
  }

  public GetApplyItemResponse setBeanList(List<top.itcat.rpc.service.model.ApplyItem> beanList) {
  ...
  public GetApplyItemResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetApplyItemResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.ApplyItem>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetApplyItemResponse)
      return this.equals((GetApplyItemResponse)that);
    return false;
  }

  public boolean equals(GetApplyItemResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetApplyItemResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetApplyItemResponse(");
    boolean first = true;
  ...
  private static class GetApplyItemResponseStandardSchemeFactory implements SchemeFactory {
    public GetApplyItemResponseStandardScheme getScheme() {
      return new GetApplyItemResponseStandardScheme();
    }
  }

  private static class GetApplyItemResponseStandardScheme extends StandardScheme<GetApplyItemResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetApplyItemResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.ApplyItem>(_list256.size);
                top.itcat.rpc.service.model.ApplyItem _elem257;
                for (int _i258 = 0; _i258 < _list256.size; ++_i258)
                {
                  _elem257 = new top.itcat.rpc.service.model.ApplyItem();
                  _elem257.read(iprot);
                  struct.beanList.add(_elem257);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetApplyItemResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.ApplyItem _iter259 : struct.beanList)
            {
  ...
  private static class GetApplyItemResponseTupleSchemeFactory implements SchemeFactory {
    public GetApplyItemResponseTupleScheme getScheme() {
      return new GetApplyItemResponseTupleScheme();
    }
  }

  private static class GetApplyItemResponseTupleScheme extends TupleScheme<GetApplyItemResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetApplyItemResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.ApplyItem _iter260 : struct.beanList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetApplyItemResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.ApplyItem>(_list261.size);
          top.itcat.rpc.service.model.ApplyItem _elem262;
          for (int _i263 = 0; _i263 < _list261.size; ++_i263)
          {
            _elem262 = new top.itcat.rpc.service.model.ApplyItem();
            _elem262.read(iprot);
            struct.beanList.add(_elem262);
          }
        }
        struct.setBeanListIsSet(true);
      }
