...
public class GetPrescriptionHerbRequest implements org.apache.thrift.TBase<GetPrescriptionHerbRequest, GetPrescriptionHerbRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPrescriptionHerbRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetPrescriptionHerbRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetPrescriptionHerbRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetPrescriptionHerbRequestTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.IDS,_Fields.DOCTOR_ID,_Fields.MEDICAL_RECORD_NO,_Fields.OFFSET,_Fields.LIMIT};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetPrescriptionHerbRequest.class, metaDataMap);
  }

  public GetPrescriptionHerbRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public GetPrescriptionHerbRequest(GetPrescriptionHerbRequest other) {
  ...
  public GetPrescriptionHerbRequest deepCopy() {
    return new GetPrescriptionHerbRequest(this);
  }
  ...
  public GetPrescriptionHerbRequest setIds(List<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public GetPrescriptionHerbRequest setDoctorId(long doctorId) {
  ...
  public GetPrescriptionHerbRequest setMedicalRecordNo(long medicalRecordNo) {
  ...
  public GetPrescriptionHerbRequest setOffset(int offset) {
    this.offset = offset;
    setOffsetIsSet(true);
    return this;
  }
  ...
  public GetPrescriptionHerbRequest setLimit(int limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetPrescriptionHerbRequest)
      return this.equals((GetPrescriptionHerbRequest)that);
    return false;
  }

  public boolean equals(GetPrescriptionHerbRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetPrescriptionHerbRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetPrescriptionHerbRequest(");
    boolean first = true;
  ...
  private static class GetPrescriptionHerbRequestStandardSchemeFactory implements SchemeFactory {
    public GetPrescriptionHerbRequestStandardScheme getScheme() {
      return new GetPrescriptionHerbRequestStandardScheme();
    }
  }

  private static class GetPrescriptionHerbRequestStandardScheme extends StandardScheme<GetPrescriptionHerbRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetPrescriptionHerbRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new ArrayList<Long>(_list90.size);
                long _elem91;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPrescriptionHerbRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetPrescriptionHerbRequestTupleSchemeFactory implements SchemeFactory {
    public GetPrescriptionHerbRequestTupleScheme getScheme() {
      return new GetPrescriptionHerbRequestTupleScheme();
    }
  }

  private static class GetPrescriptionHerbRequestTupleScheme extends TupleScheme<GetPrescriptionHerbRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionHerbRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionHerbRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.ids = new ArrayList<Long>(_list95.size);
          long _elem96;
          for (int _i97 = 0; _i97 < _list95.size; ++_i97)
          {
            _elem96 = iprot.readI64();
            struct.ids.add(_elem96);
          }
        }
        struct.setIdsIsSet(true);
      }
