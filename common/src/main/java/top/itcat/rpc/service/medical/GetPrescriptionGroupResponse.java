...
public class GetPrescriptionGroupResponse implements org.apache.thrift.TBase<GetPrescriptionGroupResponse, GetPrescriptionGroupResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetPrescriptionGroupResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetPrescriptionGroupResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetPrescriptionGroupResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetPrescriptionGroupResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.PrescriptionGroup> beanList; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.BEAN_LIST, new org.apache.thrift.meta_data.FieldMetaData("beanList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, top.itcat.rpc.service.model.PrescriptionGroup.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetPrescriptionGroupResponse.class, metaDataMap);
  }

  public GetPrescriptionGroupResponse() {
  }
   ...
   */
  public GetPrescriptionGroupResponse(GetPrescriptionGroupResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetBeanList()) {
      List<top.itcat.rpc.service.model.PrescriptionGroup> __this__beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionGroup>(other.beanList.size());
      for (top.itcat.rpc.service.model.PrescriptionGroup other_element : other.beanList) {
        __this__beanList.add(new top.itcat.rpc.service.model.PrescriptionGroup(other_element));
      }
  ...
  public GetPrescriptionGroupResponse deepCopy() {
    return new GetPrescriptionGroupResponse(this);
  }
  ...
  public java.util.Iterator<top.itcat.rpc.service.model.PrescriptionGroup> getBeanListIterator() {
    return (this.beanList == null) ? null : this.beanList.iterator();
  }

  public void addToBeanList(top.itcat.rpc.service.model.PrescriptionGroup elem) {
    if (this.beanList == null) {
      this.beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionGroup>();
    }
    this.beanList.add(elem);
  }

  public List<top.itcat.rpc.service.model.PrescriptionGroup> getBeanList() {
    return this.beanList;
  }

  public GetPrescriptionGroupResponse setBeanList(List<top.itcat.rpc.service.model.PrescriptionGroup> beanList) {
  ...
  public GetPrescriptionGroupResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public GetPrescriptionGroupResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BEAN_LIST:
      if (value == null) {
        ...
        setBeanList((List<top.itcat.rpc.service.model.PrescriptionGroup>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetPrescriptionGroupResponse)
      return this.equals((GetPrescriptionGroupResponse)that);
    return false;
  }

  public boolean equals(GetPrescriptionGroupResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetPrescriptionGroupResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetPrescriptionGroupResponse(");
    boolean first = true;
  ...
  private static class GetPrescriptionGroupResponseStandardSchemeFactory implements SchemeFactory {
    public GetPrescriptionGroupResponseStandardScheme getScheme() {
      return new GetPrescriptionGroupResponseStandardScheme();
    }
  }

  private static class GetPrescriptionGroupResponseStandardScheme extends StandardScheme<GetPrescriptionGroupResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetPrescriptionGroupResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionGroup>(_list16.size);
                top.itcat.rpc.service.model.PrescriptionGroup _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new top.itcat.rpc.service.model.PrescriptionGroup();
                  _elem17.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetPrescriptionGroupResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.beanList != null) {
        if (struct.isSetBeanList()) {
          oprot.writeFieldBegin(BEAN_LIST_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.PrescriptionGroup _iter19 : struct.beanList)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetPrescriptionGroupResponseTupleSchemeFactory implements SchemeFactory {
    public GetPrescriptionGroupResponseTupleScheme getScheme() {
      return new GetPrescriptionGroupResponseTupleScheme();
    }
  }

  private static class GetPrescriptionGroupResponseTupleScheme extends TupleScheme<GetPrescriptionGroupResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBeanList()) {
        {
          ...
          for (top.itcat.rpc.service.model.PrescriptionGroup _iter20 : struct.beanList)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPrescriptionGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.beanList = new ArrayList<top.itcat.rpc.service.model.PrescriptionGroup>(_list21.size);
          top.itcat.rpc.service.model.PrescriptionGroup _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new top.itcat.rpc.service.model.PrescriptionGroup();
            _elem22.read(iprot);
