...
public class MGetPatientResponse implements org.apache.thrift.TBase<MGetPatientResponse, MGetPatientResponse._Fields>, java.io.Serializable, Cloneable, Comparable<MGetPatientResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MGetPatientResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new MGetPatientResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MGetPatientResponseTupleSchemeFactory());
  }

  public List<top.itcat.rpc.service.model.Patient> users; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MGetPatientResponse.class, metaDataMap);
  }

  public MGetPatientResponse() {
  }
   ...
   */
  public MGetPatientResponse(MGetPatientResponse other) {
  ...
  public MGetPatientResponse deepCopy() {
    return new MGetPatientResponse(this);
  }
  ...
  public MGetPatientResponse setUsers(List<top.itcat.rpc.service.model.Patient> users) {
    this.users = users;
    return this;
  }
  ...
  public MGetPatientResponse setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public MGetPatientResponse setBaseResp(top.itcat.rpc.base.BaseResp BaseResp) {
    this.BaseResp = BaseResp;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MGetPatientResponse)
      return this.equals((MGetPatientResponse)that);
    return false;
  }

  public boolean equals(MGetPatientResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MGetPatientResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MGetPatientResponse(");
    boolean first = true;
  ...
  private static class MGetPatientResponseStandardSchemeFactory implements SchemeFactory {
    public MGetPatientResponseStandardScheme getScheme() {
      return new MGetPatientResponseStandardScheme();
    }
  }

  private static class MGetPatientResponseStandardScheme extends StandardScheme<MGetPatientResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MGetPatientResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<top.itcat.rpc.service.model.Patient>(_list168.size);
                top.itcat.rpc.service.model.Patient _elem169;
                for (int _i170 = 0; _i170 < _list168.size; ++_i170)
                {
                  _elem169 = new top.itcat.rpc.service.model.Patient();
                  _elem169.read(iprot);
                  struct.users.add(_elem169);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MGetPatientResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.users != null) {
        if (struct.isSetUsers()) {
          oprot.writeFieldBegin(USERS_FIELD_DESC);
          {
            ...
            for (top.itcat.rpc.service.model.Patient _iter171 : struct.users)
            {
  ...
  private static class MGetPatientResponseTupleSchemeFactory implements SchemeFactory {
    public MGetPatientResponseTupleScheme getScheme() {
      return new MGetPatientResponseTupleScheme();
    }
  }

  private static class MGetPatientResponseTupleScheme extends TupleScheme<MGetPatientResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MGetPatientResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUsers()) {
        {
          ...
          for (top.itcat.rpc.service.model.Patient _iter172 : struct.users)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MGetPatientResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.users = new ArrayList<top.itcat.rpc.service.model.Patient>(_list173.size);
          top.itcat.rpc.service.model.Patient _elem174;
          for (int _i175 = 0; _i175 < _list173.size; ++_i175)
          {
            _elem174 = new top.itcat.rpc.service.model.Patient();
            _elem174.read(iprot);
            struct.users.add(_elem174);
          }
        }
        struct.setUsersIsSet(true);
      }
